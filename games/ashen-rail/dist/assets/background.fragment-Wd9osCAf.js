...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var S={name:b,shader:x},C=`intersectionFunctions`,w=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T={name:C,shader:w},E=`backgroundPixelShader`,D=`#ifdef TEXTURELODSUPPORT
...
`;e.ShadersStore[E]||(e.ShadersStore[E]=D);var O=[S,i,o,t,c,l,u,d,f,a,p,m,h,s,n,g,T,r,_,v,y];for(let t of O)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var k={name:E,shader:D};export{k as t};