import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./packingFunctions-CINwVZs6.js";import{t as n}from"./clipPlaneFragmentDeclaration-DYuu9Qqk.js";import{t as r}from"./clipPlaneFragment-F6cElb9_.js";import{t as i}from"./shadowMapFragment-DwkJ2ApE.js";var a=`bayerDitherFunctions`,o=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var s={name:a,shader:o},c=`shadowMapFragmentExtraDeclaration`,l=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var u={name:c,shader:l},d=`shadowMapPixelShader`,f=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[d]||(e.ShadersStoreWGSL[d]=f);var p=[t,s,u,n,r,i];for(let t of p)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var m={name:d,shader:f};export{m as t};