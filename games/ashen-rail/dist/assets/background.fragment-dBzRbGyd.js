...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x={name:y,shader:b},S=`backgroundPixelShader`,C=`#include<backgroundUboDeclaration>
...
`;e.ShadersStoreWGSL[S]||(e.ShadersStoreWGSL[S]=C);var w=[i,o,t,c,l,u,d,a,f,p,m,s,n,h,x,r,g,_,v];for(let t of w)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var T={name:S,shader:C};export{T as t};