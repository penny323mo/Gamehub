import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./instancesDeclaration-CJBvtBV5.js";import{t as n}from"./instancesVertex-C-FoRQR1.js";var r=`greasedLineVertexShader`,i=`precision highp float;
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=i);var a=[t,n];for(let t of a)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var o={name:r,shader:i};export{o as t};