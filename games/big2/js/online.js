...
function initOnlineMode() {
    ...
    OnlineState.clientId = sessionStorage.getItem('big2_clientId');
    if (!OnlineState.clientId) {
        OnlineState.clientId = crypto.randomUUID();
        sessionStorage.setItem('big2_clientId', OnlineState.clientId);
    }
...
async function startGameFromHost() {
    ...
    OnlineState.sbClient.rpc('cleanup_big2_actions', { p_room_id: OnlineState.roomUuid, p_client_id: OnlineState.clientId })
