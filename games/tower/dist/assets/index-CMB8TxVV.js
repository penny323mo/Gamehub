...
#endif`;const ke={alphahash_fragment:wp,alphahash_pars_fragment:Tp,alphamap_fragment:Ep,alphamap_pars_fragment:Ap,alphatest_fragment:Rp,alphatest_pars_fragment:Cp,aomap_fragment:Pp,aomap_pars_fragment:Lp,batching_pars_vertex:Ip,batching_vertex:Dp,begin_vertex:Up,beginnormal_vertex:Np,bsdfs:Fp,iridescence_fragment:kp,bumpmap_pars_fragment:Op,clipping_planes_fragment:Bp,clipping_planes_pars_fragment:zp,clipping_planes_pars_vertex:Hp,clipping_planes_vertex:Gp,color_fragment:Vp,color_pars_fragment:Wp,color_pars_vertex:Xp,color_vertex:qp,common:Yp,cube_uv_reflection_fragment:jp,defaultnormal_vertex:$p,displacementmap_pars_vertex:Kp,displacementmap_vertex:Zp,emissivemap_fragment:Jp,emissivemap_pars_fragment:Qp,colorspace_fragment:em,colorspace_pars_fragment:tm,envmap_fragment:nm,envmap_common_pars_fragment:im,envmap_pars_fragment:rm,envmap_pars_vertex:sm,envmap_physical_pars_fragment:gm,envmap_vertex:om,fog_vertex:am,fog_pars_vertex:lm,fog_fragment:cm,fog_pars_fragment:um,gradientmap_pars_fragment:dm,lightmap_pars_fragment:hm,lights_lambert_fragment:fm,lights_lambert_pars_fragment:pm,lights_pars_begin:mm,lights_toon_fragment:vm,lights_toon_pars_fragment:xm,lights_phong_fragment:_m,lights_phong_pars_fragment:ym,lights_physical_fragment:Sm,lights_physical_pars_fragment:Mm,lights_fragment_begin:bm,lights_fragment_maps:wm,lights_fragment_end:Tm,logdepthbuf_fragment:Em,logdepthbuf_pars_fragment:Am,logdepthbuf_pars_vertex:Rm,logdepthbuf_vertex:Cm,map_fragment:Pm,map_pars_fragment:Lm,map_particle_fragment:Im,map_particle_pars_fragment:Dm,metalnessmap_fragment:Um,metalnessmap_pars_fragment:Nm,morphinstance_vertex:Fm,morphcolor_vertex:km,morphnormal_vertex:Om,morphtarget_pars_vertex:Bm,morphtarget_vertex:zm,normal_fragment_begin:Hm,normal_fragment_maps:Gm,normal_pars_fragment:Vm,normal_pars_vertex:Wm,normal_vertex:Xm,normalmap_pars_fragment:qm,clearcoat_normal_fragment_begin:Ym,clearcoat_normal_fragment_maps:jm,clearcoat_pars_fragment:$m,iridescence_pars_fragment:Km,opaque_fragment:Zm,packing:Jm,premultiplied_alpha_fragment:Qm,project_vertex:eg,dithering_fragment:tg,dithering_pars_fragment:ng,roughnessmap_fragment:ig,roughnessmap_pars_fragment:rg,shadowmap_pars_fragment:sg,shadowmap_pars_vertex:og,shadowmap_vertex:ag,shadowmask_pars_fragment:lg,skinbase_vertex:cg,skinning_pars_vertex:ug,skinning_vertex:dg,skinnormal_vertex:hg,specularmap_fragment:fg,specularmap_pars_fragment:pg,tonemapping_fragment:mg,tonemapping_pars_fragment:gg,transmission_fragment:vg,transmission_pars_fragment:xg,uv_pars_fragment:_g,uv_pars_vertex:yg,uv_vertex:Sg,worldpos_vertex:Mg,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function xu(){return new wt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ol(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function _u(){return new wt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ol(),fragmentShader:`
	...
	`}function Ig(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===qo||l===Yo,u=l===Xi||l===qi;if(c||u){let d=e.get(a);const h=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new gu(i)),d=c?t.fromEquirectangular(a,d):t.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),d.texture;if(d!==void 0)return d.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&r(f)?(t===null&&(t=new gu(i)),d=c?t.fromEquirectangular(a):t.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),a.addEventListener("dispose",s),d.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Dg(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Vr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Ug(i,e,t,n){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const v=h.morphAttributes[g];for(let m=0,p=v.length;m<p;m++)e.remove(v[m])}h.removeEventListener("dispose",o),delete r[h.id];const f=s.get(h);f&&(e.remove(f),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const g in h)e.update(h[g],i.ARRAY_BUFFER);const f=d.morphAttributes;for(const g in f){const v=f[g];for(let m=0,p=v.length;m<p;m++)e.update(v[m],i.ARRAY_BUFFER)}}function c(d){const h=[],f=d.index,g=d.attributes.position;let v=0;if(f!==null){const b=f.array;v=f.version;for(let w=0,_=b.length;w<_;w+=3){const I=b[w+0],E=b[w+1],R=b[w+2];h.push(I,E,E,R,R,I)}}else if(g!==void 0){const b=g.array;v=g.version;for(let w=0,_=b.length/3-1;w<_;w+=3){const I=w+0,E=w+1,R=w+2;h.push(I,E,E,R,R,I)}}else return;const m=new(kc(h)?iu:nu)(h,1);m.version=v;const p=s.get(d);p&&e.remove(p),s.set(d,m)}function u(d){const h=s.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:u}}function Ng(i,e,t){let n;function r(h){n=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function l(h,f){i.drawElements(n,f,s,h*o),t.update(f,n,1)}function c(h,f,g){g!==0&&(i.drawElementsInstanced(n,f,s,h*o,g),t.update(f,n,g))}function u(h,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,s,h,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function d(h,f,g,v){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/o,f[p],v[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,s,h,0,v,0,g);let p=0;for(let b=0;b<g;b++)p+=f[b]*v[b];t.update(p,n,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function Fg(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function kg(i,e,t){const n=new WeakMap,r=new Je;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(a);if(h===void 0||h.count!==d){let M=function(){R.dispose(),n.delete(a),a.removeEventListener("dispose",M)};h!==void 0&&h.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let w=0;f===!0&&(w=1),g===!0&&(w=2),v===!0&&(w=3);let _=a.attributes.position.count*w,I=1;_>e.maxTextureSize&&(I=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);const E=new Float32Array(_*I*4*d),R=new Xc(E,_,I,d);R.type=dn,R.needsUpdate=!0;const D=w*4;for(let S=0;S<d;S++){const C=m[S],H=p[S],z=b[S],W=_*I*4*S;for(let K=0;K<C.count;K++){const X=K*D;f===!0&&(r.fromBufferAttribute(C,K),E[W+X+0]=r.x,E[W+X+1]=r.y,E[W+X+2]=r.z,E[W+X+3]=0),g===!0&&(r.fromBufferAttribute(H,K),E[W+X+4]=r.x,E[W+X+5]=r.y,E[W+X+6]=r.z,E[W+X+7]=0),v===!0&&(r.fromBufferAttribute(z,K),E[W+X+8]=r.x,E[W+X+9]=r.y,E[W+X+10]=r.z,E[W+X+11]=z.itemSize===4?r.w:1)}}h={count:d,texture:R,size:new we(_,I)},n.set(a,h),a.addEventListener("dispose",M)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let f=0;for(let v=0;v<c.length;v++)f+=c[v];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function Og(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,d=e.get(l,u);if(r.get(d)!==c&&(e.update(d),r.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==c&&(h.update(),r.set(h,c))}return d}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class yu extends Mt{constructor(e,t,n,r,s,o,a,l,c,u=$i){if(u!==$i&&u!==Ki)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===$i&&(n=Ei),n===void 0&&u===Ki&&(n=ji),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:kt,this.minFilter=l!==void 0?l:kt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Su=new Mt,Mu=new yu(1,1),bu=new Xc,wu=new sp,Tu=new du,Eu=[],Au=[],Ru=new Float32Array(16),Cu=new Float32Array(9),Pu=new Float32Array(4);function gr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Eu[r];if(s===void 0&&(s=new Float32Array(r),Eu[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function yt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function eo(i,e){let t=Au[e];t===void 0&&(t=new Int32Array(e),Au[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Bg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function zg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function Hg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function Gg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function Vg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(yt(t,n))return;Pu.set(n),i.uniformMatrix2fv(this.addr,!1,Pu),St(t,n)}}function Wg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(yt(t,n))return;Cu.set(n),i.uniformMatrix3fv(this.addr,!1,Cu),St(t,n)}}function Xg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(yt(t,n))return;Ru.set(n),i.uniformMatrix4fv(this.addr,!1,Ru),St(t,n)}}function qg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Yg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function jg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function $g(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function Kg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Zg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function Jg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function Qg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function e0(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Mu.compareFunction=Uc,s=Mu):s=Su,t.setTexture2D(e||s,r)}function t0(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||wu,r)}function n0(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Tu,r)}function i0(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||bu,r)}function r0(i){switch(i){case 5126:return Bg;case 35664:return zg;case 35665:return Hg;case 35666:return Gg;case 35674:return Vg;case 35675:return Wg;case 35676:return Xg;case 5124:case 35670:return qg;case 35667:case 35671:return Yg;case 35668:case 35672:return jg;case 35669:case 35673:return $g;case 5125:return Kg;case 36294:return Zg;case 36295:return Jg;case 36296:return Qg;case 35678:case 36198:case 36298:case 36306:case 35682:return e0;case 35679:case 36299:case 36307:return t0;case 35680:case 36300:case 36308:case 36293:return n0;case 36289:case 36303:case 36311:case 36292:return i0}}function s0(i,e){i.uniform1fv(this.addr,e)}function o0(i,e){const t=gr(e,this.size,2);i.uniform2fv(this.addr,t)}function a0(i,e){const t=gr(e,this.size,3);i.uniform3fv(this.addr,t)}function l0(i,e){const t=gr(e,this.size,4);i.uniform4fv(this.addr,t)}function c0(i,e){const t=gr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function u0(i,e){const t=gr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function d0(i,e){const t=gr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function h0(i,e){i.uniform1iv(this.addr,e)}function f0(i,e){i.uniform2iv(this.addr,e)}function p0(i,e){i.uniform3iv(this.addr,e)}function m0(i,e){i.uniform4iv(this.addr,e)}function g0(i,e){i.uniform1uiv(this.addr,e)}function v0(i,e){i.uniform2uiv(this.addr,e)}function x0(i,e){i.uniform3uiv(this.addr,e)}function _0(i,e){i.uniform4uiv(this.addr,e)}function y0(i,e,t){const n=this.cache,r=e.length,s=eo(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Su,s[o])}function S0(i,e,t){const n=this.cache,r=e.length,s=eo(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||wu,s[o])}function M0(i,e,t){const n=this.cache,r=e.length,s=eo(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Tu,s[o])}function b0(i,e,t){const n=this.cache,r=e.length,s=eo(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||bu,s[o])}function w0(i){switch(i){case 5126:return s0;case 35664:return o0;case 35665:return a0;case 35666:return l0;case 35674:return c0;case 35675:return u0;case 35676:return d0;case 5124:case 35670:return h0;case 35667:case 35671:return f0;case 35668:case 35672:return p0;case 35669:case 35673:return m0;case 5125:return g0;case 36294:return v0;case 36295:return x0;case 36296:return _0;case 35678:case 36198:case 36298:case 36306:case 35682:return y0;case 35679:case 36299:case 36307:return S0;case 35680:case 36300:case 36308:case 36293:return M0;case 36289:case 36303:case 36311:case 36292:return b0}}class T0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=r0(t.type)}}class E0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=w0(t.type)}}class A0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const al=/(\w+)(\])?(\[|\.)?/g;function Lu(i,e){i.seq.push(e),i.map[e.id]=e}function R0(i,e,t){const n=i.name,r=n.length;for(al.lastIndex=0;;){const s=al.exec(n),o=al.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Lu(t,c===void 0?new T0(a,i,e):new E0(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new A0(a),Lu(t,d)),t=d}}}class to{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);R0(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Iu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const C0=37297;let P0=0;function L0(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Du=new Ue;function I0(i){We._getMatrix(Du,We.workingColorSpace,i);const e=`mat3( ${Du.elements.map(t=>t.toFixed(4))} )`;switch(We.getTransfer(i)){case Is:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Uu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+L0(i.getShaderSource(e),o)}else return r}function D0(i,e){const t=I0(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function U0(i,e){let t;switch(e){case mc:t="Linear";break;case vf:t="Reinhard";break;case xf:t="Cineon";break;case gc:t="ACESFilmic";break;case yf:t="AgX";break;case Sf:t="Neutral";break;case _f:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const no=new A;function N0(){We.getLuminanceCoefficients(no);const i=no.x.toFixed(4),e=no.y.toFixed(4),t=no.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function F0(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Kr).join(`
`)}function k0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function O0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Kr(i){return i!==""}function Nu(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Fu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const B0=/^[ \t]*#include +<([\w\d./]+)>/gm;function ll(i){return i.replace(B0,H0)}const z0=new Map;function H0(i,e){let t=ke[e];if(t===void 0){const n=z0.get(e);if(n!==void 0)t=ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ll(t)}const G0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ku(i){return i.replace(G0,V0)}function V0(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ou(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function W0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===No?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===$h?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Nn&&(e="SHADOWMAP_TYPE_VSM"),e}function X0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Xi:case qi:e="ENVMAP_TYPE_CUBE";break;case ws:e="ENVMAP_TYPE_CUBE_UV";break}return e}function q0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case qi:e="ENVMAP_MODE_REFRACTION";break}return e}function Y0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Xo:e="ENVMAP_BLENDING_MULTIPLY";break;case mf:e="ENVMAP_BLENDING_MIX";break;case gf:e="ENVMAP_BLENDING_ADD";break}return e}function j0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function $0(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=W0(t),c=X0(t),u=q0(t),d=Y0(t),h=j0(t),f=F0(t),g=k0(s),v=r.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `});this.scene.add(new Re(t,n))}buildTerrainUnderlay(){const e=te.cols+ze.terrain.underlayPadding*2,t=te.rows+ze.terrain.underlayPadding*2,n=ze.terrain.underlaySegments,r=new Sn(e,t,n,n);r.rotateX(-Math.PI/2);const s=r.attributes.position,o=new Float32Array(s.count*3),a=te.origin.x+te.cols*te.cellSize/2,l=te.origin.z+te.rows*te.cellSize/2;for(let d=0;d<s.count;d++){const h=s.getX(d)+a,f=s.getZ(d)+l,g=Math.max(0,Math.abs(h-a)-te.cols*.52),v=Math.max(0,Math.abs(f-l)-te.rows*.52),m=Math.sqrt(g*g+v*v),p=Ia.smoothstep(m,.25,ze.terrain.underlayPadding),b=Math.sin(h*.22)*Math.cos(f*.18)*.16,w=Math.sin((h+f)*.11)*.12,_=(b+w)*p-.58;s.setY(d,_);const I=Ia.clamp(.5+p*.26+_*.12,0,1),E=new se(3959617),R=new se(7645282),D=E.lerp(R,I);o[d*3]=D.r,o[d*3+1]=D.g,o[d*3+2]=D.b}r.setAttribute("color",new gt(o,3)),r.computeVertexNormals();const c=ze.isMobile?new ts({vertexColors:!0}):new Mn({vertexColors:!0,roughness:.98,metalness:.01}),u=new Re(r,c);u.receiveShadow=!0,this.scene.add(u)}buildBoardFrame(e){const t=new jn(te.cols+1.35,.2,te.rows+1.35),n=ze.isMobile?new ts({color:3099955}):new Mn({color:3099955,roughness:.8,metalness:0}),r=new Re(t,n);r.position.copy(e),r.position.y=-.34,r.receiveShadow=!0,this.scene.add(r)}addRoadSegment(e,t,n,r,s,o,a){const l=new Re(new jn(n,r,t),a);l.position.copy(e),l.position.y=s,l.rotation.y=o,l.receiveShadow=!0,this.scene.add(l)}async buildPads(){const e=te.buildCells??[];if(e.length!==0){await Ol(["scenery/woodStructure.glb"]);for(const[t,n]of e){const r=Tt(t,n),s=await kl("scenery/woodStructure.glb");s.position.set(r.x,.2,r.z),s.scale.set(.92,.55,.92),this.scene.add(s)}}}async buildScenery(){const{cols:e,rows:t,cellSize:n}=te,r=(d,h,f)=>{const g=Math.sin(d*127.1+h*311.7+f*74.7)*43758.5453;return g-Math.floor(g)},s=["scenery/detail_tree.glb","scenery/detail_treeLarge.glb"],o=["scenery/detail_rocks.glb","scenery/detail_rocksLarge.glb"],a=["scenery/detail_crystal.glb","scenery/detail_crystalLarge.glb"],l=ze.isMobile?5:9,c=ze.isMobile?.18:.34,u=ze.isMobile?.06:.14;for(let d=-l;d<e+l;d++)for(let h=-l;h<t+l;h++){if(d>=-1&&d<=e&&h>=-1&&h<=t)continue;const f=r(d,h,1);let g=null;if(f<c?g=s[r(d,h,2)<.62?0:1]:f<c+u?g=o[r(d,h,3)<.6?0:1]:f<c+u+.02&&(g=a[r(d,h,4)<.7?0:1]),!g)continue;const v=Tt(d,h),m=await kl(g);m.position.set(v.x+(r(d,h,5)-.5)*n*.8,0,v.z+(r(d,h,6)-.5)*n*.8),m.rotation.y=r(d,h,7)*Math.PI*2,m.scale.setScalar(.8+r(d,h,8)*.9),this.scene.add(m)}}buildDistantSilhouettes(){const e=new es(2.8,6.5,4),t=ze.isMobile?new ts({color:1057560}):new Mn({color:1057560,roughness:.95,metalness:.01}),n=te.cols*.75,r=te.rows*.95,s=te.origin.x+te.cols*te.cellSize/2,o=te.origin.z+te.rows*te.cellSize/2,a=ze.isMobile?8:18;for(let l=0;l<a;l++){const c=l/a*Math.PI*2,u=new Re(e,t);u.position.set(s+Math.cos(c)*(n+10+Math.random()*5),1.8+Math.random()*.9,o+Math.sin(c)*(r+10+Math.random()*5)),u.scale.setScalar(.8+Math.random()*1.2),u.rotation.y=Math.random()*Math.PI*2,u.castShadow=!1,u.receiveShadow=!0,this.scene.add(u)}}}const C_=10,jd=4,$d=22,P_=40,L_=35,Bl=20;class I_{constructor(){J(this,"cam");J(this,"frustum",C_);J(this,"tilt",P_*Math.PI/180);J(this,"yaw",L_*Math.PI/180);J(this,"cx");J(this,"cz");J(this,"lastPinchDist",0);J(this,"lastRotAngle",0);J(this,"isTwoFinger",!1);J(this,"shakeAmount",0);J(this,"shakeOffset",{x:0,y:0,z:0});J(this,"onTouchStart",e=>{e.touches.length===2&&(this.isTwoFinger=!0,this.lastPinchDist=Zd(e),this.lastRotAngle=Jd(e))});J(this,"onTouchMove",e=>{if(e.touches.length!==2)return;e.preventDefault(),this.isTwoFinger=!0;const t=Zd(e);if(this.lastPinchDist>0){const r=this.lastPinchDist/t;this.frustum=Kd(this.frustum*r,jd,$d),this.rebuildProjection()}this.lastPinchDist=t;const n=Jd(e);if(this.lastRotAngle!==0){const r=n-this.lastRotAngle;this.yaw+=r}this.lastRotAngle=n,this.applyTransform()});J(this,"onTouchEnd",e=>{e.touches.length<2&&(this.lastPinchDist=0,this.lastRotAngle=0,setTimeout(()=>{this.isTwoFinger=!1},100))});const e=window.innerWidth/window.innerHeight;this.cam=new $r(-this.frustum*e,this.frustum*e,this.frustum,-this.frustum,.1,100),this.cx=te.origin.x+te.cols*te.cellSize/2,this.cz=te.origin.z+te.rows*te.cellSize/2,this.applyTransform()}get twoFingerActive(){return this.isTwoFinger}zoom(e){this.frustum=Kd(this.frustum+e*.01,jd,$d),this.rebuildProjection(),this.applyTransform()}resize(e){this.rebuildProjection(),e.setSize(window.innerWidth,window.innerHeight)}shake(e){this.shakeAmount=Math.max(this.shakeAmount,e)}tickShake(e){if(this.shakeAmount<=.001){(this.shakeOffset.x!==0||this.shakeOffset.y!==0||this.shakeOffset.z!==0)&&(this.shakeOffset.x=0,this.shakeOffset.y=0,this.shakeOffset.z=0,this.applyTransform()),this.shakeAmount=0;return}const t=this.shakeAmount;this.shakeOffset.x=(Math.random()-.5)*t,this.shakeOffset.y=(Math.random()-.5)*t*.45,this.shakeOffset.z=(Math.random()-.5)*t,this.applyTransform(),this.shakeAmount=Math.max(0,this.shakeAmount-e*2.2*(.2+this.shakeAmount))}rebuildProjection(){const e=window.innerWidth/window.innerHeight;this.cam.left=-this.frustum*e,this.cam.right=this.frustum*e,this.cam.top=this.frustum,this.cam.bottom=-this.frustum,this.cam.updateProjectionMatrix()}applyTransform(){this.cam.position.set(this.cx+Bl*Math.sin(this.yaw)*Math.cos(this.tilt)+this.shakeOffset.x,Bl*Math.sin(this.tilt)+this.shakeOffset.y,this.cz+Bl*Math.cos(this.yaw)*Math.cos(this.tilt)+this.shakeOffset.z),this.cam.lookAt(this.cx+this.shakeOffset.x*.3,0,this.cz+this.shakeOffset.z*.3)}}function Kd(i,e,t){return Math.max(e,Math.min(t,i))}function Zd(i){const e=i.touches[0],t=i.touches[1],n=e.clientX-t.clientX,r=e.clientY-t.clientY;return Math.sqrt(n*n+r*r)}function Jd(i){const e=i.touches[0],t=i.touches[1];return Math.atan2(t.clientY-e.clientY,t.clientX-e.clientX)}function D_(i){const e=te.origin.x+te.cols*te.cellSize/2,t=te.origin.z+te.rows*te.cellSize/2;i.fog=new ul(ze.atmosphere.fogColor,ze.atmosphere.fogDensity);const n=new Zv(15268832,2835507,1.35);i.add(n);const r=new nx(4023888,.42);i.add(r);const s=new mo(16774358,2);s.position.set(e+10,16,t-7),s.target.position.set(e,0,t),s.castShadow=ze.enableShadows,s.shadow.mapSize.width=2048,s.shadow.mapSize.height=2048,s.shadow.camera.near=.5,s.shadow.camera.far=52,s.shadow.camera.left=-18,s.shadow.camera.right=18,s.shadow.camera.top=16,s.shadow.camera.bottom=-16,s.shadow.bias=-7e-4,s.shadow.normalBias=.02,s.shadow.radius=4,i.add(s),i.add(s.target);const o=new mo(11064550,.65);o.position.set(e-13,10,t+9),o.target.position.set(e,0,t),i.add(o),i.add(o.target);const a=new mo(11991002,.4);a.position.set(e,6,t+18),a.target.position.set(e,.4,t),i.add(a),i.add(a.target);const l=te.spawnCell,c=new po(6870527,2.4,9,1.6);c.position.set(te.origin.x+l[0]*te.cellSize+te.cellSize/2,1.6,te.origin.z+l[1]*te.cellSize+te.cellSize/2),i.add(c);const u=te.goalCell,d=new po(16744284,2.1,9,1.7);return d.position.set(te.origin.x+u[0]*te.cellSize+te.cellSize/2,1.6,te.origin.z+u[1]*te.cellSize+te.cellSize/2),i.add(d),{update(h){const f=1.9+Math.sin(h*ze.atmosphere.spawnPulseSpeed)*.55,g=1.7+Math.sin(h*ze.atmosphere.goalPulseSpeed+1.2)*.45;c.intensity=f,d.intensity=g,c.position.y=1.55+Math.sin(h*1.7)*.08,d.position.y=1.55+Math.sin(h*1.35+.8)*.08,s.intensity=1.95+Math.sin(h*.35)*.08,o.intensity=.62+Math.sin(h*.27+1.5)*.04,a.intensity=.38+Math.sin(h*.41+.3)*.03}}}const Qd={arrow:9136404,arrow_rapid:11044146,arrow_pierce:7229967,cannon:5592405,ice:6737151,fire:16733440,lightning:16772608,poison:6750003,sniper:3355545,cannon_siege:4013380,ice_glacier:3121112,fire_inferno:13840128,lightning_storm:14205952,poison_plague:3129119,sniper_railgun:2039662},zl={arrow:14527027,arrow_rapid:16763989,arrow_pierce:12290082,cannon:8947848,ice:11202303,fire:16746564,lightning:16777130,poison:11206519,sniper:6710988,cannon_siege:12303300,ice_glacier:14546687,fire_inferno:16759654,lightning_storm:16777181,poison_plague:13434794,sniper_railgun:10066414};class U_{constructor(e){J(this,"scene");J(this,"meshes",new Map);J(this,"sellingTowers",new Set);J(this,"rangeRing",null);J(this,"time",0);this.scene=e}sync(e){const t=new Set(e.towers.map(n=>n.id));for(const[n,r]of this.meshes)t.has(n)||(this.scene.remove(r),this.meshes.delete(n));for(const n of e.towers)if(!this.meshes.has(n.id)){const r=this.createTowerMesh(n);r.scale.set(0,0,0),r.userData.buildProgress=0,this.scene.add(r),this.meshes.set(n.id,r)}}removeTower(e){const t=this.meshes.get(e);t&&(this.sellingTowers.add({group:t,timer:.25,maxTimer:.25}),this.meshes.delete(e))}animate(e,t){this.time+=e;const n=this.time;for(const r of this.sellingTowers)if(r.timer-=e,r.timer<=0)this.scene.remove(r.group),this.sellingTowers.delete(r);else{const s=r.timer/r.maxTimer,o=s*s*s;r.group.scale.set(o,o,o),r.group.rotation.y+=e*10}for(const r of t.towers){const s=this.meshes.get(r.id);if(!s)continue;const o=s.userData;if(o.buildProgress<1){o.buildProgress=Math.min(1,o.buildProgress+e*3);const l=o.buildProgress,c=2*Math.PI/3,u=l===1?1:Math.pow(2,-10*l)*Math.sin((l*10-.75)*c)+1;s.scale.set(u,u,u)}if(r.cooldownRemaining>o.lastCooldown&&(o.attackTimer=.15),o.lastCooldown=r.cooldownRemaining,o.buildProgress>=1)if(o.attackTimer>0){o.attackTimer-=e;const l=Math.max(0,o.attackTimer/.15),c=1+l*.12;o.turretGroup?o.turretGroup.scale.set(c,c,c):s.scale.set(c,c,c),o.recoilNode&&(o.recoilNode.position.z=-(o.recoilAmount??.08)*l),o.energyRingMaterial&&(o.energyRingMaterial.emissiveIntensity=.3+l*.75)}else o.turretGroup&&o.turretGroup.scale.set(1,1,1),o.recoilNode&&(o.recoilNode.position.z=0),s.scale.set(1,1,1),o.energyRingMaterial&&(o.energyRingMaterial.emissiveIntensity=.22+Math.sin(n*2.5)*.08);let a=null;if(r.targetId!==null&&r.targetId!==void 0){const l=t.enemies.find(c=>c.id===r.targetId);if(l){const c=l.worldX-r.worldX,u=l.worldZ-r.worldZ;(c!==0||u!==0)&&(a=Math.atan2(c,u))}}if(a===null&&r.aimAngle!==void 0&&(a=r.aimAngle),a!==null&&o.turretGroup){let l=a-o.turretGroup.rotation.y;l=Math.atan2(Math.sin(l),Math.cos(l)),o.turretGroup.rotation.y+=l*10*e}if(o.spin)for(const l of o.spin)l.node.rotation[l.axis]+=e*l.speed;if(o.bob)for(const l of o.bob)l.node.position.y=l.baseY+Math.sin(n*l.speed+l.phase)*l.amp;if(o.pulseScale)for(const l of o.pulseScale){const c=l.base+Math.sin(n*l.speed+l.phase)*l.amp;l.yOnly?l.node.scale.y=c:l.node.scale.set(c,c,c)}if(o.pulseEmissive)for(const l of o.pulseEmissive)l.mat.emissiveIntensity=l.base+Math.sin(n*l.speed+l.phase)*l.amp;if(o.orbit)for(const l of o.orbit)l.pivot.rotation.y+=e*l.speed;if(o.rise)for(const l of o.rise){const c=(n*l.speed+l.phase)%1;l.node.position.y=l.baseY+c*l.height;const u=1-c;l.node.scale.setScalar(.4+u*.6)}if(o.arcs&&o.arcOrigin&&(o.arcTimer=(o.arcTimer??0)-e,o.arcTimer<=0)){o.arcTimer=.06;for(const l of o.arcs){const c=l.geometry.attributes.position,u=o.arcOrigin,d=Math.random()*Math.PI*2,h=.22+Math.random()*.16,f=u.x+Math.cos(d)*h,g=u.y-.1-Math.random()*.25,v=u.z+Math.sin(d)*h,m=c.count;for(let p=0;p<m;p++){const b=p/(m-1),w=(Math.random()-.5)*.08*(p>0&&p<m-1?1:0),_=(Math.random()-.5)*.08*(p>0&&p<m-1?1:0);c.setXYZ(p,u.x+(f-u.x)*b+w,u.y+(g-u.y)*b+_,u.z+(v-u.z)*b+w)}c.needsUpdate=!0,l.visible=Math.random()>.25}}}}showRange(e,t){if(!this.rangeRing){this.rangeRing=new It;const o=new Re(new Ni(.92,1,64),new Be({color:16777215,transparent:!0,opacity:.16,side:st,depthWrite:!1}));o.rotation.x=-Math.PI/2;const a=new Re(new Ni(.6,.66,64),new Be({color:16777215,transparent:!0,opacity:.08,side:st,depthWrite:!1}));a.rotation.x=-Math.PI/2;const l=new Re(new ho(.98,48),new Be({color:16777215,transparent:!0,opacity:.04,side:st,depthWrite:!1}));l.rotation.x=-Math.PI/2,l.position.y=-.002,this.rangeRing.add(o,a,l),this.rangeRing.userData={outer:o,inner:a,pulse:l},this.scene.add(this.rangeRing)}const n=zl[e.type]??16777215,r=this.rangeRing.userData;r.outer.material.color.setHex(n),r.inner.material.color.setHex(n),r.pulse.material.color.setHex(n);const s=1+Math.sin(this.time*3.2)*.06;r.pulse.scale.setScalar(s),r.pulse.position.y=.002,this.rangeRing.scale.set(t,t,1),this.rangeRing.position.set(e.worldX,.03,e.worldZ),this.rangeRing.visible=!0}hideRange(){this.rangeRing&&(this.rangeRing.visible=!1)}measure(e){const t=this.meshes.get(e);if(!t)return null;const n=new en().setFromObject(t);let r=0;const s=new Set;return t.traverse(o=>{const a=o;if(a.isMesh){r+=1;for(const l of Array.isArray(a.material)?a.material:[a.material]){const c=l;c!=null&&c.color&&th.has(c.name)&&s.add("#"+c.color.getHexString())}}}),{高:+(n.max.y-n.min.y).toFixed(3),件:r,色:[...s].sort()}}createTowerMesh(e){const t=new It,n=Tt(e.col,e.row);t.position.set(n.x,0,n.z);const r=t.userData;r.buildProgress=0,r.lastCooldown=0,r.attackTimer=0;const s=eh[e.type]??eh.arrow,o=new se(Qd[e.type]??Qd.arrow),a=new se(zl[e.type]??zl.arrow),l=["bottom","middle","top"],c=["towers/towerRound_base.glb"];for(let h=0;h<=Math.min(e.level,2);h+=1)c.push(`towers/${s.家}_${l[h]}${s.款}.glb`);let u=0;for(const h of c){const f=Kt(h);f.position.y=u,yo(f,o,a),t.add(f),u+=h.includes("_base")?.21:.5}const d=new It;if(d.position.y=u,t.add(d),r.turretGroup=d,s.武器){const h=Kt(`towers/weapon_${s.武器}.glb`);h.scale.setScalar(s.武器大細??1),yo(h,a,o);const f=new It;f.add(h),d.add(f),r.recoilNode=f,r.recoilAmount=.09}else{const h=Kt(`towers/${s.家}_roof${s.款}.glb`);yo(h,o,a),d.add(h);const f=new en().setFromObject(h).max.y,g=Kt("towers/towerRound_crystals.glb");g.position.y=f+.16,g.scale.setScalar(.55),yo(g,a,a),d.add(g),r.spin=[{node:g,axis:"y",speed:.7}]}return t}}const eh={arrow:{家:"towerRound",款:"A",武器:"ballista"},arrow_rapid:{家:"towerRound",款:"B",武器:"ballista",武器大細:.85},arrow_pierce:{家:"towerRound",款:"C",武器:"ballista",武器大細:1.15},cannon:{家:"towerSquare",款:"A",武器:"cannon"},cannon_siege:{家:"towerSquare",款:"C",武器:"cannon",武器大細:1.2},ice:{家:"towerRound",款:"B"},ice_glacier:{家:"towerRound",款:"C"},fire:{家:"towerSquare",款:"B",武器:"catapult"},fire_inferno:{家:"towerSquare",款:"C",武器:"catapult",武器大細:1.15},lightning:{家:"towerRound",款:"C",武器:"blaster"},lightning_storm:{家:"towerRound",款:"A",武器:"blaster",武器大細:1.15},poison:{家:"towerSquare",款:"B"},poison_plague:{家:"towerSquare",款:"A"},sniper:{家:"towerSquare",款:"C",武器:"blaster",武器大細:1.3},sniper_railgun:{家:"towerSquare",款:"B",武器:"blaster",武器大細:1.45}},th=new Set(["red","purple"]),N_=new Set(["wood","crystal"]);function yo(i,e,t){i.traverse(n=>{const r=n;if(!r.isMesh)return;const o=(Array.isArray(r.material)?r.material:[r.material]).map(a=>{const l=a,c=th.has(l.name),u=N_.has(l.name);if(!c&&!u)return l;const d=l.clone();return d.color.copy(c?e:t),l.name==="purple"&&d.color.multiplyScalar(.68),d});r.material=Array.isArray(r.material)?o:o[0]})}const cs=(i,e=10)=>(t,n,r)=>{t.oy+=Math.abs(Math.sin(n*e+r))*i},nh=(i,e)=>(t,n,r)=>{t.oy+=Math.sin(n*e+r)*i},ih={grunt:{barY:.95,shadowScale:1},tank:{barY:1.05,shadowScale:1.55},runner:{barY:.9,shadowScale:.95},swarm:{barY:.72,shadowScale:.65},shield:{barY:1.1,shadowScale:1.1},healer:{barY:1.15,shadowScale:1},boss:{barY:2.1,shadowScale:1.95}},rh={grunt:{檔:"skeleton",縮:.6,抬:.39},tank:{檔:"digger",縮:.52,抬:.39},runner:{檔:"ghost",縮:.46,抬:1.43},swarm:{檔:"skeleton",縮:.38,色:10475680,抬:.39},shield:{檔:"zombie",縮:.58,色:8373992,抬:.39},healer:{檔:"vampire",縮:.55,色:15771856,抬:.48},boss:{檔:"vampire",縮:1.15,色:16751181,抬:.48}},F_={grunt:cs(.055,9),tank:cs(.035,5.5),runner:nh(.08,3.2),swarm:cs(.07,13),shield:cs(.04,7),healer:nh(.05,2.4),boss:cs(.06,4)},Hl={grunt:[],tank:[],runner:[],swarm:[],shield:[],healer:[],boss:[]};function k_(){for(const i of Object.keys(rh)){const e=rh[i],t=Kt(`enemies/${e.檔}.glb`);t.updateMatrixWorld(!0);const n=[];t.traverse(r=>{const s=r;if(!s.isMesh)return;const o=s.geometry.clone();o.applyMatrix4(s.matrixWorld),o.scale(e.縮,e.縮,e.縮),o.translate(0,e.抬*e.縮,0);for(const a of Array.isArray(s.material)?s.material:[s.material]){const l=a.clone();e.色&&l.color.lerp(new se(e.色),.55),n.push({geo:o,mat:l,offset:new A(0,0,0),anim:F_[i]});break}}),Hl[i]=n}}const O_=100,us=.5,Gl=100,sh=new Sn(1,.06),B_=new Sn(1,.04),z_=new ho(.26,12),H_=new Ni(.18,.24,12);class G_{constructor(e){J(this,"scene");J(this,"instancedMeshGroups",new Map);J(this,"dummy",new ut);J(this,"animOut",{ox:0,oy:0,oz:0,rx:0,ry:0,rz:0,s:1});J(this,"mHpBg",new Be({color:3355443,side:st,depthWrite:!1}));J(this,"mHpGreen",new Be({color:4521796,side:st,depthWrite:!1}));J(this,"mHpYellow",new Be({color:16755200,side:st,depthWrite:!1}));J(this,"mHpRed",new Be({color:16724787,side:st,depthWrite:!1}));J(this,"mShield",new Be({color:4491519,side:st,depthWrite:!1}));J(this,"mShadow",new Be({color:0,transparent:!0,opacity:.18,side:st,depthWrite:!1}));J(this,"mHaloBoss",new Be({color:16752215,transparent:!0,opacity:.5,side:st,depthWrite:!1}));J(this,"mHaloShield",new Be({color:7131135,transparent:!0,opacity:.5,side:st,depthWrite:!1}));J(this,"mHaloSlow",new Be({color:9300223,transparent:!0,opacity:.5,side:st,depthWrite:!1}));J(this,"mHaloDot",new Be({color:7667562,transparent:!0,opacity:.5,side:st,depthWrite:!1}));J(this,"poolHpBg",[]);J(this,"poolHpFill",[]);J(this,"poolShield",[]);J(this,"poolShadow",[]);J(this,"poolHalo",[]);this.scene=e,this.dummy.rotation.order="YXZ",this.initPool()}initPool(){const e=(t,n,r)=>{const s=new Re(t,n);return s.visible=!1,s.renderOrder=r,this.scene.add(s),s};for(let t=0;t<Gl;t++)this.poolHpBg.push(e(sh,this.mHpBg,1)),this.poolHpFill.push(e(sh,this.mHpGreen,2)),this.poolShield.push(e(B_,this.mShield,2)),ze.isMobile||(this.poolShadow.push(e(z_,this.mShadow,0)),this.poolHalo.push(e(H_,this.mHaloDot,0)))}getOrCreate(e){let t=this.instancedMeshGroups.get(e);if(!t){t=[];const n=Hl[e];for(const r of n){const s=new Qu(r.geo,r.mat,O_);s.count=0,ze.enableShadows&&(s.castShadow=!0,s.receiveShadow=!0),this.scene.add(s),t.push(s)}this.instancedMeshGroups.set(e,t)}return t}sync(e,t,n){const r=new Map,s=[];for(const u of e.enemies){if(!u.alive||u.reached)continue;let d=r.get(u.type);d||(d=[],r.set(u.type,d)),d.push(u),s.push(u)}const o=performance.now()*.001,a=this.animOut,l=["grunt","tank","runner","swarm","shield","healer","boss"];for(const u of l){const d=this.getOrCreate(u),h=r.get(u)||[];for(const g of d)g.count=h.length;const f=Hl[u];for(let g=0;g<h.length;g++){const v=h[g],m=v.worldX-v.prevWorldX,p=v.worldZ-v.prevWorldZ;let b=0;Math.abs(m)>.001||Math.abs(p)>.001?(b=Math.atan2(m,p),v.displayRot=b):v.displayRot!==void 0&&(b=v.displayRot);const w=v.id*.7;for(let _=0;_<f.length;_++){const I=f[_];a.ox=0,a.oy=0,a.oz=0,a.rx=0,a.ry=0,a.rz=0,a.s=1,I.anim&&I.anim(a,o,w),this.dummy.position.set(v.worldX+a.ox,a.oy,v.worldZ+a.oz),this.dummy.position.add(I.offset),this.dummy.rotation.set(a.rx,b+a.ry,a.rz),I.rotation&&(this.dummy.rotation.x+=I.rotation.x,this.dummy.rotation.y+=I.rotation.y,this.dummy.rotation.z+=I.rotation.z),I.scale?this.dummy.scale.copy(I.scale).multiplyScalar(a.s):this.dummy.scale.set(a.s,a.s,a.s),this.dummy.updateMatrix(),d[_].setMatrixAt(g,this.dummy.matrix)}}for(const g of d)g.instanceMatrix.needsUpdate=!0}const c=Math.min(s.length,Gl);for(let u=0;u<c;u++){const d=s[u],h=d.type==="boss",f=ih[d.type].barY,g=Math.max(0,d.hp/d.maxHp),v=us*g,m=this.poolHpBg[u];m.scale.set(us,1,1),m.position.set(d.worldX,f,d.worldZ),m.visible=!0,n?m.lookAt(n.position):m.rotation.x=-Math.PI/4;const p=this.poolHpFill[u];v>.001?(p.material=g>.5?this.mHpGreen:g>.25?this.mHpYellow:this.mHpRed,p.scale.set(v,1,1),p.position.set(d.worldX-(us-v)/2,f,d.worldZ),p.visible=!0,n?p.lookAt(n.position):p.rotation.x=-Math.PI/4):p.visible=!1;const b=this.poolShield[u];if(d.maxShield>0&&d.shield>0){const w=d.shield/d.maxShield,_=us*w;b.scale.set(_,1,1),b.position.set(d.worldX-(us-_)/2,f+.07,d.worldZ),b.visible=!0,n?b.lookAt(n.position):b.rotation.x=-Math.PI/4}else b.visible=!1;if(!ze.isMobile&&u<this.poolShadow.length){const w=this.poolShadow[u];w.scale.setScalar(ih[d.type].shadowScale),w.position.set(d.worldX,.01,d.worldZ),w.visible=!0;const _=this.poolHalo[u];d.slow||d.dots.length>0||d.shield>0||h?(_.material=h?this.mHaloBoss:d.shield>0?this.mHaloShield:d.slow?this.mHaloSlow:this.mHaloDot,_.position.set(d.worldX,.045,d.worldZ),_.visible=!0):_.visible=!1}}for(let u=c;u<Gl;u++)this.poolHpBg[u].visible=!1,this.poolHpFill[u].visible=!1,this.poolShield[u].visible=!1,!ze.isMobile&&u<this.poolShadow.length&&(this.poolShadow[u].visible=!1,this.poolHalo[u].visible=!1)}}const oh={arrow:16768324,arrow_rapid:16773017,arrow_pierce:9348863,cannon:16737843,ice:8969727,fire:16729088,lightning:16776960,poison:6750003,sniper:11184895},So=i=>oh[i]??oh[i.includes("_")?i.split("_")[0]:i]??16777215,Vt=ze.maxParticles,ds=ze.isMobile?35:80,sn={minX:-6,maxX:16,minZ:-6,maxZ:16},hs={min:.4,max:4.5};class V_{constructor(e){J(this,"scene");J(this,"projScaleY",1.7);J(this,"particles",[]);J(this,"particleGeo");J(this,"particlePositions");J(this,"particleColors");J(this,"particleSizes");J(this,"particleAlphas");J(this,"particlePoints");J(this,"moteGeo");J(this,"motePositions");J(this,"moteVelocities");J(this,"motePhase");J(this,"motePoints");this.scene=e,this.particlePositions=new Float32Array(Vt*3),this.particleColors=new Float32Array(Vt*3),this.particleSizes=new Float32Array(Vt),this.particleAlphas=new Float32Array(Vt),this.particleGeo=new Rt,this.particleGeo.setAttribute("position",new gt(this.particlePositions,3)),this.particleGeo.setAttribute("aColor",new gt(this.particleColors,3)),this.particleGeo.setAttribute("aSize",new gt(this.particleSizes,1)),this.particleGeo.setAttribute("aAlpha",new gt(this.particleAlphas,1));const t=new wt({vertexShader:`
		...
		}`};class fs{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const q_=new $r(-1,1,1,-1,0,1);class Y_ extends Rt{constructor(){super(),this.setAttribute("position",new pt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new pt([0,2,0,0,2,0],2))}}const j_=new Y_;class ch{constructor(e){this._mesh=new Re(j_,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,q_)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class uh extends fs{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof wt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ks.clone(e.uniforms),this.material=new wt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new ch(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class dh extends fs{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const r=e.getContext(),s=e.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),s.buffers.stencil.setFunc(r.ALWAYS,o,4294967295),s.buffers.stencil.setClear(a),s.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(r.EQUAL,1,4294967295),s.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),s.buffers.stencil.setLocked(!0)}}class $_ extends fs{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class K_{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new we);this._width=n.width,this._height=n.height,t=new pn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:zn}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new uh(lh),this.copyPass.material.blending=kn,this.clock=new rx}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let r=0,s=this.passes.length;r<s;r++){const o=this.passes[r];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(r),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}dh!==void 0&&(o instanceof dh?n=!0:o instanceof $_&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new we);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Z_ extends fs{constructor(e,t,n=null,r=null,s=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=s,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new se}render(e,t,n){const r=e.autoClear;e.autoClear=!1;let s,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(s=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(s),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=r}}const J_={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new se(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Tr.BlurDirectionX=new we(1,0),Tr.BlurDirectionY=new we(0,1);class Q_{constructor(e,t,n){J(this,"composer");J(this,"bloomPass");J(this,"gradePass");this.composer=new K_(e);const r=new Z_(t,n);this.composer.addPass(r),this.bloomPass=new Tr(new we(window.innerWidth,window.innerHeight),ze.atmosphere.bloomStrength,ze.atmosphere.bloomRadius,ze.atmosphere.bloomThreshold),this.composer.addPass(this.bloomPass),this.gradePass=new uh(new wt({uniforms:{tDiffuse:{value:null},uTime:{value:0},uVignetteStrength:{value:ze.atmosphere.vignetteStrength},uGrainAmount:{value:ze.atmosphere.grainAmount},uContrast:{value:1.06},uSaturation:{value:1.08},uTint:{value:new A(.98,1.02,.98)}},vertexShader:`
                    varying vec2 vUv;
                    void main() {
                        vUv = uv;
                        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
                ...
                `}),"tDiffuse"),this.composer.addPass(this.gradePass)}render(){this.gradePass.uniforms.uTime.value=performance.now()*.001,this.composer.render()}resize(e,t){this.composer.setSize(e,t),this.bloomPass.setSize(e,t)}setTint(e,t,n){this.gradePass.uniforms.uTint.value.set(e,t,n)}}class ey{constructor(){J(this,"ctx",null);J(this,"enabled",!0);J(this,"musicStarted",!1);J(this,"musicMaster",null);J(this,"prepGain",null);J(this,"waveGain",null);J(this,"musicPhase","off");J(this,"waveBeatTimer",null)}init(){this.ctx||(this.ctx=new(window.AudioContext||window.webkitAudioContext)),this.ctx.state==="suspended"&&this.ctx.resume()}toggle(){return this.enabled=!this.enabled,this.musicMaster&&this.ctx&&this.musicMaster.gain.linearRampToValueAtTime(this.enabled?1:0,this.ctx.currentTime+.2),this.enabled}playTone(e,t,n,r){if(!this.enabled||!this.ctx)return;const s=this.ctx.createOscillator(),o=this.ctx.createGain();s.type=t,s.frequency.setValueAtTime(e,this.ctx.currentTime),s.connect(o),o.connect(this.ctx.destination),o.gain.setValueAtTime(r,this.ctx.currentTime),o.gain.exponentialRampToValueAtTime(.01,this.ctx.currentTime+n),s.start(),s.stop(this.ctx.currentTime+n)}playShoot(){this.playTone(400,"square",.1,.05)}playHit(){this.playTone(150,"sawtooth",.15,.05)}playBuild(){this.playTone(600,"sine",.2,.1),setTimeout(()=>this.playTone(800,"sine",.2,.1),100)}playSell(){this.playTone(500,"triangle",.2,.1),setTimeout(()=>this.playTone(300,"triangle",.3,.1),100)}playError(){this.playTone(100,"sawtooth",.2,.1)}playStreakStinger(){if(!this.enabled||!this.ctx)return;[523,659,784,988].forEach((t,n)=>{setTimeout(()=>this.playTone(t,"triangle",.18,.06),n*60)})}playMegaStingerHit(){if(!this.enabled||!this.ctx)return;[392,523,659,784,1047].forEach((t,n)=>{setTimeout(()=>this.playTone(t,"sawtooth",.22,.07),n*70)})}playBossRoar(){if(!this.enabled||!this.ctx)return;const e=this.ctx,t=e.currentTime,n=e.createOscillator();n.type="sawtooth",n.frequency.setValueAtTime(50,t),n.frequency.exponentialRampToValueAtTime(28,t+.9);const r=e.createGain();r.gain.setValueAtTime(.18,t),r.gain.exponentialRampToValueAtTime(.01,t+1),n.connect(r),r.connect(e.destination),n.start(t),n.stop(t+1.05);const s=e.createBuffer(1,e.sampleRate*.8,e.sampleRate),o=s.getChannelData(0);for(let u=0;u<o.length;u++)o[u]=(Math.random()*2-1)*(1-u/o.length);const a=e.createBufferSource();a.buffer=s;const l=e.createGain();l.gain.setValueAtTime(.08,t),l.gain.exponentialRampToValueAtTime(.01,t+.8);const c=e.createBiquadFilter();c.type="lowpass",c.frequency.value=400,a.connect(c),c.connect(l),l.connect(e.destination),a.start(t),a.stop(t+.8)}playVictory(){if(!this.enabled||!this.ctx)return;[523,659,784,1047,1319].forEach((t,n)=>{setTimeout(()=>this.playTone(t,"triangle",.35,.08),n*110)})}playDefeat(){if(!this.enabled||!this.ctx)return;[523,466,392,311].forEach((t,n)=>{setTimeout(()=>this.playTone(t,"sawtooth",.4,.08),n*150)})}startMusic(){if(this.musicStarted||!this.ctx)return;this.musicStarted=!0;const e=this.ctx,t=e.createGain();t.gain.value=this.enabled?1:0,t.connect(e.destination),this.musicMaster=t;const n=e.createGain();n.gain.value=.035;const r=e.createBiquadFilter();r.type="lowpass",r.frequency.value=420,r.Q.value=.4,n.connect(r),r.connect(t);for(const l of[55,82]){const c=e.createOscillator();c.type="sine",c.frequency.value=l;const u=e.createOscillator();u.frequency.value=.07;const d=e.createGain();d.gain.value=2.5,u.connect(d),d.connect(c.frequency),c.connect(n),c.start(),u.start()}const s=e.createGain();s.gain.value=0,s.connect(t),this.prepGain=s;for(const l of[220,329.63,440]){const c=e.createOscillator();c.type="triangle",c.frequency.value=l;const u=e.createGain();u.gain.value=.02,c.connect(u),u.connect(s),c.start()}const o=e.createGain();o.gain.value=0,o.connect(t),this.waveGain=o;const a=e.createBiquadFilter();a.type="bandpass",a.frequency.value=600,a.Q.value=1.4,a.connect(o);for(const l of[110,164.81,220]){const c=e.createOscillator();c.type="sawtooth",c.frequency.value=l;const u=e.createGain();u.gain.value=.018,c.connect(u),u.connect(a),c.start()}}setMusicPhase(e){if(!this.ctx||(this.musicStarted||this.startMusic(),this.musicPhase===e))return;this.musicPhase=e;const t=this.ctx.currentTime,n=1.4,r=e==="prep"?.7:0,s=e==="wave"?.85:0;this.prepGain&&(this.prepGain.gain.cancelScheduledValues(t),this.prepGain.gain.setValueAtTime(this.prepGain.gain.value,t),this.prepGain.gain.linearRampToValueAtTime(r,t+n)),this.waveGain&&(this.waveGain.gain.cancelScheduledValues(t),this.waveGain.gain.setValueAtTime(this.waveGain.gain.value,t),this.waveGain.gain.linearRampToValueAtTime(s,t+n)),this.waveBeatTimer!==null&&(clearInterval(this.waveBeatTimer),this.waveBeatTimer=null),e==="wave"&&(this.waveBeatTimer=window.setInterval(()=>{if(!this.enabled||!this.ctx||this.musicPhase!=="wave")return;const o=this.ctx,a=o.currentTime,l=o.createOscillator();l.type="sine",l.frequency.setValueAtTime(90,a),l.frequency.exponentialRampToValueAtTime(40,a+.18);const c=o.createGain();c.gain.setValueAtTime(.08,a),c.gain.exponentialRampToValueAtTime(.001,a+.2),l.connect(c),this.musicMaster&&c.connect(this.musicMaster),l.start(a),l.stop(a+.22)},620))}}const Dt=new ey,hh="tower-defense-v1",Vl={runs:0,victories:0,totalKills:0,totalWavesCleared:0,totalTowersBuilt:0,highestWaveReached:0},Wl={prefs:{difficulty:"normal",soundEnabled:!0,speedMultiplier:1,endlessMode:!1},highScores:{},achievements:[],lifetime:{...Vl}};function ty(){try{const i=localStorage.getItem(hh);if(!i)return structuredClone(Wl);const e=JSON.parse(i);return{prefs:{...Wl.prefs,...e.prefs??{}},highScores:e.highScores??{},achievements:e.achievements??[],lifetime:{...Vl,...e.lifetime??{}}}}catch{return structuredClone(Wl)}}function xi(i){try{localStorage.setItem(hh,JSON.stringify(i))}catch{}}function ny(i,e,t,n,r){const s=i.highScores[e];return!s||t>s.score?(i.highScores[e]={score:t,wave:n,rank:r,date:Date.now()},xi(i),!0):!1}function iy(i,e){return i.achievements.includes(e)?!1:(i.achievements.push(e),xi(i),!0)}function ry(i,e,t,n,r,s){i.lifetime.runs+=1,e&&(i.lifetime.victories+=1),i.lifetime.totalKills+=t,i.lifetime.totalWavesCleared+=n,i.lifetime.totalTowersBuilt+=r,s>i.lifetime.highestWaveReached&&(i.lifetime.highestWaveReached=s),xi(i)}function sy(i){i.highScores={},i.achievements=[],i.lifetime={...Vl},xi(i)}const Xl=[{id:"first_blood",name:"First Blood",desc:"Score your very first kill",emoji:"🩸",check:(i,e)=>e.event==="enemyKilled"&&i.totalKills===1},{id:"streak_10",name:"Combo Rookie",desc:"Hit a 10-kill streak",emoji:"🔥",check:(i,e)=>e.event==="streakBonus"&&e.payload.streak>=10},{id:"streak_25",name:"Combo Master",desc:"Hit a 25-kill streak",emoji:"⚡",check:(i,e)=>e.event==="streakBonus"&&e.payload.streak>=25},{id:"perfect_wave",name:"Untouchable",desc:"Clear a wave without losing any lives",emoji:"🛡",check:(i,e)=>e.event==="waveCleared"&&e.payload.perfect===!0},{id:"milestone_25",name:"Holding the Line",desc:"Reach Wave 25",emoji:"🏁",check:(i,e)=>e.event==="milestone"&&e.payload.wave>=25},{id:"milestone_50",name:"Frontline Veteran",desc:"Reach Wave 50",emoji:"🎖",check:(i,e)=>e.event==="milestone"&&e.payload.wave>=50},{id:"milestone_75",name:"War Commander",desc:"Reach Wave 75",emoji:"👑",check:(i,e)=>e.event==="milestone"&&e.payload.wave>=75},{id:"victory",name:"Bastion Triumphant",desc:"Clear all 99 waves",emoji:"🏆",check:(i,e)=>e.event==="gameOver"&&e.payload.won===!0},{id:"victory_hard",name:"Iron Legend",desc:"Clear all 99 waves on Hard",emoji:"💠",check:(i,e)=>e.event==="gameOver"&&e.payload.won===!0&&i.difficulty==="hard"},{id:"frugal",name:"Frugal Commander",desc:"Clear Wave 25 with only 3 towers or fewer",emoji:"💡",check:(i,e)=>e.event==="waveCleared"&&e.payload.wave>=25&&i.towers.length<=3}],ql="towerDefense.uiLayout.v1",oy=450,ay=12;function ly(){try{return JSON.parse(localStorage.getItem(ql)||"{}")}catch{return{}}}function cy(i){try{localStorage.setItem(ql,JSON.stringify(i))}catch{}}let Mo=ly();const fh=[],bo=(i,e,t)=>Math.min(Math.max(i,e),Math.max(e,t));function uy(){window.addEventListener("click",i=>{i.stopPropagation(),i.preventDefault()},{capture:!0,once:!0})}function ki(i,e){if(!i)return;i.classList.add("draggable-panel");const t=()=>{const h=Mo[e];if(!h||i.classList.contains("hidden"))return;const f=i.offsetWidth,g=i.offsetHeight;if(!f||!g)return;const v=bo(h.x*(window.innerWidth-f),0,window.innerWidth-f),m=bo(h.y*(window.innerHeight-g),0,window.innerHeight-g);i.style.left=`${v}px`,i.style.top=`${m}px`,i.style.right="auto",i.style.bottom="auto",i.style.transform="none"};fh.push({el:i,apply:t}),t(),new MutationObserver(t).observe(i,{attributes:!0,attributeFilter:["class"]}),window.addEventListener("resize",t);let n=0,r=-1,s=!1,o=0,a=0,l=0,c=0;const u=()=>{var f;s=!0;const h=i.getBoundingClientRect();l=o-h.left,c=a-h.top,i.style.left=`${h.left}px`,i.style.top=`${h.top}px`,i.style.right="auto",i.style.bottom="auto",i.style.transform="none",i.classList.add("ui-dragging"),(f=navigator.vibrate)==null||f.call(navigator,20)};i.addEventListener("pointerdown",h=>{if(!(s||r!==-1||!h.isPrimary)){r=h.pointerId,o=h.clientX,a=h.clientY;try{i.setPointerCapture(r)}catch{}n=window.setTimeout(u,oy)}}),i.addEventListener("pointermove",h=>{if(h.pointerId!==r)return;if(!s){if(Math.hypot(h.clientX-o,h.clientY-a)>ay){clearTimeout(n);try{i.releasePointerCapture(r)}catch{}r=-1}return}h.preventDefault();const f=i.offsetWidth,g=i.offsetHeight;i.style.left=`${bo(h.clientX-l,0,window.innerWidth-f)}px`,i.style.top=`${bo(h.clientY-c,0,window.innerHeight-g)}px`});const d=h=>{if(h.pointerId!==r)return;clearTimeout(n);try{i.releasePointerCapture(r)}catch{}if(r=-1,!s)return;s=!1,i.classList.remove("ui-dragging");const f=i.offsetWidth,g=i.offsetHeight;Mo[e]={x:(parseFloat(i.style.left)||0)/Math.max(1,window.innerWidth-f),y:(parseFloat(i.style.top)||0)/Math.max(1,window.innerHeight-g)},cy(Mo),uy()};i.addEventListener("pointerup",d),i.addEventListener("pointercancel",d)}function dy(){Mo={};try{localStorage.removeItem(ql)}catch{}for(const{el:i}of fh)i.style.left="",i.style.top="",i.style.right="",i.style.bottom="",i.style.transform=""}const hy=Math.PI*.62,fy=.18,py=.85;class ph{constructor(e){J(this,"scene");J(this,"門扇",[]);J(this,"開度",0);J(this,"閃",0);J(this,"閃燈",null);J(this,"光環",null);J(this,"光幕",null);J(this,"光柱",null);J(this,"血條",null);J(this,"血條底",null);J(this,"血條長",2.1);J(this,"血條位",new A);J(this,"上次命",-1);J(this,"旗",[]);J(this,"time",0);this.scene=e}static 清單(){return["structures/wallDoorwaySquareWide.glb","structures/wallDoor.glb","structures/pillarStone.glb","structures/wallArch.glb","structures/wall.glb","structures/wallWindowRound.glb","structures/wallCorner.glb","structures/roofHighPoint.glb","structures/bannerRed.glb","structures/bannerGreen.glb","structures/lantern.glb","structures/stairsStone.glb"]}build(){this.buildSpawnGate(),this.buildGoalKeep()}buildSpawnGate(){const[e,t]=te.spawnCell,n=Tt(e,t),r=new It;r.position.set(n.x,0,n.z);const s=te.path[1]??te.path[0],o=Tt(s[0],s[1]);r.rotation.y=Math.atan2(o.x-n.x,o.z-n.z)+Math.PI/2,r.scale.setScalar(1.25),this.scene.add(r);const a=Kt("structures/wallDoorwaySquareWide.glb");a.scale.setScalar(1.45),ps(a,14212579,10134702),r.add(a);for(const d of[-1,1]){const h=Kt("structures/pillarStone.glb");h.position.set(d*.72,0,0),h.scale.set(1.35,1.75,1.35),ps(h,14870250,10924217),r.add(h);const f=Kt("structures/lantern.glb");f.position.set(d*.72,1.72,0),f.scale.setScalar(.9),r.add(f)}for(const d of[-1,1]){const h=new It;h.position.set(d*.66,0,0),r.add(h);const f=Kt("structures/wallDoor.glb");f.position.set(-d*.34,0,0),f.scale.set(1.3,1.45,1.3),ps(f,13208139,9264174),h.add(f),this.門扇.push({node:h,閂角:0,方向:d})}this.閃燈=new po(10219263,0,12,1.2),this.閃燈.position.set(0,.9,0),r.add(this.閃燈);const l=new Re(new Ni(.3,.62,44),new Be({color:11072255,transparent:!0,opacity:0,side:st,depthWrite:!1,blending:ri}));l.rotation.x=-Math.PI/2,l.position.y=.28,r.add(l),this.光環=l;const c=new Re(new Sn(1.35,1.55),new Be({color:10350335,transparent:!0,opacity:.16,side:st,depthWrite:!1,blending:ri}));c.rotation.y=Math.PI/2,c.position.set(0,.66,0),r.add(c),this.光幕=c;const u=new Re(new Cn(.34,.5,3.2,18,1,!0),new Be({color:12055807,transparent:!0,opacity:0,side:st,depthWrite:!1,blending:ri}));u.position.set(0,1.6,0),r.add(u),this.光柱=u}buildGoalKeep(){const[e,t]=te.goalCell,n=Tt(e,t),r=new It;r.position.set(n.x,0,n.z);const s=te.path[te.path.length-2]??te.path[te.path.length-1],o=Tt(s[0],s[1]);r.rotation.y=Math.atan2(o.x-n.x,o.z-n.z),r.scale.setScalar(1.35),this.scene.add(r);const a=[[-.5,0,Math.PI/2],[.5,0,Math.PI/2],[0,.5,0],[0,-.5,0]];for(const[f,g,v]of a){const m=Kt(g>0?"structures/wallWindowRound.glb":"structures/wall.glb");m.position.set(f,0,g),m.rotation.y=v,m.scale.setScalar(1),ps(m,14541543,10463666),r.add(m)}const l=new It;l.position.y=1,r.add(l);for(const[f,g,v]of a){const m=Kt("structures/wall.glb");m.position.set(f*.62,0,g*.62),m.rotation.y=v,m.scale.set(.64,.8,.64),ps(m,15265007,11318717),l.add(m)}const c=Kt("structures/roofHighPoint.glb");c.position.y=.8,c.scale.setScalar(.78),gy(c,14700607,16743270),l.add(c);for(const f of[-1,1]){const g=Kt("structures/bannerGreen.glb");g.position.set(f*.62,1.05,-.42),g.scale.setScalar(.9),r.add(g),this.旗.push(g)}const u=new A(n.x,2.7,n.z),d=new Re(new Sn(this.血條長+.14,.3),new Be({color:1313547,transparent:!0,opacity:.85,depthTest:!1,depthWrite:!1}));d.position.copy(u),d.renderOrder=900,this.scene.add(d),this.血條底=d;const h=new Re(new Sn(this.血條長,.2),new Be({color:5562474,transparent:!0,opacity:1,depthTest:!1,depthWrite:!1}));h.position.copy(u),h.renderOrder=901,this.scene.add(h),this.血條=h,this.血條位=u}開門(){this.開度=1,this.閃=1}update(e,t,n,r){this.time+=e;const o=this.開度>0?e/py:e/fy;this.開度=Math.max(0,this.開度-o);const a=hy*my(this.開度);for(const l of this.門扇)l.node.rotation.y=l.閂角+a*l.方向;if(this.閃=Math.max(0,this.閃-e/.55),this.閃燈&&(this.閃燈.intensity=this.閃*this.閃*60),this.光環){const c=.8+(1-this.閃)*5.4;this.光環.scale.set(c,c,1),this.光環.material.opacity=this.閃}if(this.光柱){const l=this.光柱.material;l.opacity=this.閃*.55;const c=.7+(1-this.閃)*.8;this.光柱.scale.set(c,1,c),this.光柱.visible=this.閃>.01}if(this.光幕){const l=this.光幕.material;l.opacity=.2+this.閃*.75+Math.sin(this.time*2.6)*.06}for(let l=0;l<this.旗.length;l+=1)this.旗[l].rotation.y=Math.sin(this.time*1.1+l*1.7)*.22;if(this.血條&&this.血條底){if(t!==this.上次命){this.上次命=t;const u=n>0?Math.max(0,Math.min(1,t/n)):0;this.血條.scale.x=Math.max(.001,u),this.血條.material.color.setHex(u>.6?5562474:u>.28?14729540:14703178)}this.血條底.quaternion.copy(r.quaternion),this.血條.quaternion.copy(r.quaternion);const l=new A(1,0,0).applyQuaternion(r.quaternion),c=this.血條.scale.x;this.血條.position.copy(this.血條位).addScaledVector(l,-(this.血條長*(1-c))/2)}}狀態(){var e;return{開度:+this.開度.toFixed(3),閃:+this.閃.toFixed(3),門角:this.門扇.map(t=>+t.node.rotation.y.toFixed(3)),血條闊:+(((e=this.血條)==null?void 0:e.scale.x)??-1).toFixed(3)}}}const my=i=>1-(1-i)*(1-i);function ps(i,e,t){i.traverse(n=>{const r=n;if(!r.isMesh)return;const o=(Array.isArray(r.material)?r.material:[r.material]).map(a=>{const l=a;if(!/^(stone|stoneDark|wood|woodDark)$/.test(l.name))return l;const c=l.clone();return c.color.setHex(/Dark$/.test(l.name)?t:e),ze.enableShadows&&(r.castShadow=!0),c});r.material=Array.isArray(r.material)?o:o[0]})}function gy(i,e,t){i.traverse(n=>{const r=n;if(!r.isMesh)return;const o=(Array.isArray(r.material)?r.material:[r.material]).map(a=>{const l=a;if(!/^roofRed/.test(l.name))return l;const c=l.clone();return c.color.setHex(l.name==="roofRedLight"?t:e),c});r.material=Array.isArray(r.material)?o:o[0]})}const at=ty();let P,bn=null,Et=null,wn=at.prefs.difficulty;const _i=document.getElementById("game-canvas"),Dn=new Rv({canvas:_i,antialias:!ze.isMobile,powerPreference:"high-performance"});Dn.setPixelRatio(ze.pixelRatio),Dn.setSize(window.innerWidth,window.innerHeight),ze.enableShadows&&(Dn.shadowMap.enabled=!0,Dn.shadowMap.type=No),Dn.toneMapping=ze.isMobile?mc:gc,Dn.toneMappingExposure=ze.isMobile?1:1.28;const Wt=new R_,Zt=new I_,on=Zt.cam,wo=D_(Wt.scene),yi=new ph(Wt.scene),mh=Tt(te.spawnCell[0],te.spawnCell[1]),vy=Promise.all([Wt.buildGround(),Ol([...ph.清單(),...S_(),...M_()])]).then(()=>{yi.build(),k_()}),an=new U_(Wt.scene),xy=new G_(Wt.scene),Jn=new V_(Wt.scene),_y=new W_(Wt.scene),Ut=new X_(Wt.scene);let Oi=null;ze.enablePostProcessing&&(Oi=new Q_(Dn,Wt.scene,on));const Si=[{wave:1,tint:[1.06,1,.93],fog:1781026},{wave:30,tint:[.98,1.02,.98],fog:1057815},{wave:60,tint:[1.08,.94,.82],fog:1840400},{wave:90,tint:[.84,.9,1.12],fog:790560}];let Yl=-1;const gh=new se;function yy(i){if(i===Yl)return;Yl=i;const e=Math.max(1,i+1);let t=Si[0],n=Si[Si.length-1];for(let d=0;d<Si.length-1;d++)if(e>=Si[d].wave&&e<=Si[d+1].wave){t=Si[d],n=Si[d+1];break}const r=n.wave===t.wave?0:(e-t.wave)/(n.wave-t.wave),s=Math.max(0,Math.min(1,r)),o=t.tint[0]+(n.tint[0]-t.tint[0])*s,a=t.tint[1]+(n.tint[1]-t.tint[1])*s,l=t.tint[2]+(n.tint[2]-t.tint[2])*s;Oi&&Oi.setTint(o,a,l);const c=new se(t.fog),u=new se(n.fog);gh.copy(c).lerp(u,s),Wt.scene.fog&&"color"in Wt.scene.fog&&Wt.scene.fog.color.copy(gh)}P=El(wn),P.speedMultiplier=at.prefs.speedMultiplier,Xe.on("streakBonus",i=>Gy(i.streak)),Xe.on("milestone",i=>{Wy(i.wave),i.wave!==99&&i.wave>0&&i.wave%25===0&&eS(i.wave)}),Xe.on("towerBuilt",i=>{const e=Tt(i.col,i.row);Jn.addBuildEffect(e.x,e.z),an.sync(P),ei()}),Xe.on("towerUpgraded",i=>{an.removeTower(i.towerId),an.sync(P),ei(),Et&&Et.id===i.towerId&&Ah(Et)}),Xe.on("towerSold",i=>{Jn.addSellEffect(i.worldX,i.worldZ),P.floatingTexts.push({id:P.nextId++,worldX:i.worldX,worldZ:i.worldZ,value:`+${i.refund}g`,color:"#ffd700",life:1.5,maxLife:1.5}),an.removeTower(i.towerId),an.sync(P),ei(),Et&&Et.id===i.towerId&&Ir()}),Xe.on("enemyKilled",i=>{const e=P.enemies.find(n=>n.id===i.enemyId),t=(e==null?void 0:e.type)==="boss"?16751181:(e==null?void 0:e.type)==="shield"?7132159:(e==null?void 0:e.type)==="healer"?16751568:16748377;Jn.addDeathEffect(i.worldX,i.worldZ,t),(e==null?void 0:e.type)==="boss"&&Zt.shake(.55)}),Xe.on("milestone",()=>Zt.shake(.35)),Xe.on("streakBonus",i=>{i.streak>=10&&Zt.shake(.25)}),Xe.on("towerFired",i=>{Jn.addMuzzleFlash(i.worldX,i.worldZ,i.towerType)}),Xe.on("aoeImpact",i=>{Jn.addImpactFlash(i.worldX,i.worldZ,i.radius,i.towerType)}),Xe.on("enemySpawned",()=>{yi.開門(),Jn.addBuildEffect(mh.x,mh.z)}),Xe.on("bossSpawned",()=>{Zt.shake(.6),Vy(),Dt.playBossRoar()}),Xe.on("streakBonus",i=>{i.streak>=10?Dt.playMegaStingerHit():Dt.playStreakStinger()}),Xe.on("gameOver",i=>{i.won?Dt.playVictory():Dt.playDefeat()});const Sy=document.getElementById("gold-val"),My=document.getElementById("lives-val"),vh=document.getElementById("wave-val"),by=document.getElementById("kills-val"),jl=document.getElementById("hud-wave"),$l=document.getElementById("wave-remain"),Kl=document.getElementById("wave-progress-fill"),Zl=document.getElementById("skip-prep-btn"),Jl=document.getElementById("pause-btn"),Ql=document.getElementById("speed-btn"),ms=document.getElementById("sound-btn"),xh=document.getElementById("enemy-panel"),wy=document.getElementById("enemy-name"),Ty=document.getElementById("enemy-hp"),Ey=document.getElementById("enemy-spd"),Ay=document.getElementById("enemy-armor"),To=document.getElementById("wave-banner"),gs=document.getElementById("wave-banner-text"),ec=document.getElementById("milestone-banner"),Eo=document.getElementById("milestone-banner-text"),Er=document.getElementById("boss-cinematic"),tc=document.getElementById("next-wave-preview"),Ry=document.getElementById("preview-icons");let Ao=-2;const vs=document.getElementById("wave-modifier"),Cy=document.getElementById("mod-emoji"),Py=document.getElementById("mod-label"),Ly=document.getElementById("mod-desc");let nc="__init__";function Iy(){const i=P.waveModifier;if(i===nc)return;if(nc=i,!i||!xo[i]){vs.classList.add("hidden");return}const e=xo[i];Cy.textContent=e.emoji,Py.textContent=e.label,Ly.textContent=e.desc,vs.classList.remove("hidden"),vs.style.animation="none",vs.offsetWidth,vs.style.animation=""}function Dy(){if(P.phase!=="prep"){tc.classList.add("hidden"),Ao=-2;return}const i=Gt.waves[P.currentWave];if(!i){tc.classList.add("hidden");return}if(Ao===P.currentWave)return;Ao=P.currentWave;const e={};for(const n of i.groups)e[n.type]=(e[n.type]||0)+n.count;const t=Object.entries(e).map(([n,r])=>`<span class="preview-chip"><span class="ico">${bh[n]||"❓"}</span><span class="cnt">×${r}</span></span>`).join("");Ry.innerHTML=t,tc.classList.remove("hidden")}Xe.on("towerBuilt",()=>Dt.playBuild()),Xe.on("towerSold",()=>Dt.playSell()),Xe.on("enemyKilled",()=>Dt.playHit());const _h=document.getElementById("floating-text-layer"),Uy=document.getElementById("help-btn"),Ar=document.getElementById("help-overlay"),Ny=document.getElementById("help-close-btn"),Fy=document.getElementById("start-screen"),ic=document.getElementById("end-screen"),yh=document.getElementById("end-title"),ky=document.getElementById("end-score"),Sh=document.getElementById("end-rank"),Mh=document.getElementById("tower-panel"),xs=document.getElementById("cancel-build-btn"),Rr=document.querySelectorAll(".build-btn[data-tower]"),_s=document.getElementById("streak-banner"),Qn=document.getElementById("tower-tooltip"),Oy=Qn.querySelector(".tooltip-name"),By=Qn.querySelector(".tooltip-type"),zy=Qn.querySelector(".tooltip-stats"),Hy=Qn.querySelector(".tooltip-special"),rc=Gt.waves.length,bh={grunt:"🧟",tank:"🐢",runner:"💨",swarm:"🐝",shield:"🛡",healer:"💚",boss:"💀"};function ei(){Sy.textContent=String(P.gold),My.textContent=String(P.lives),P.endlessMode&&P.currentWave>=rc?vh.textContent=`${P.currentWave+1} ♾`:vh.textContent=`${Math.min(P.currentWave+1,rc)}/${rc}`,by.textContent=String(P.totalKills);const i=P.enemies.filter(n=>n.alive).length,e=P.waveEnemiesTotal||0;if(P.phase==="prep"){jl.classList.add("prep");const n=Gt.prepSec,r=Math.max(0,Math.min(1,1-P.prepTimer/n));$l.textContent=`⏳ ${Math.max(0,Math.ceil(P.prepTimer))}s`,Kl.style.width=`${Math.round(r*100)}%`}else if(P.phase==="wave"&&e>0){jl.classList.remove("prep");const n=Math.max(0,P.waveEnemiesSpawned-i),r=Math.max(0,Math.min(1,n/e));$l.textContent=`${i} / ${e}`,Kl.style.width=`${Math.round(r*100)}%`}else jl.classList.remove("prep"),$l.textContent="—",Kl.style.width="0%";Zl.classList.toggle("hidden",P.phase!=="prep"),Dy(),Iy(),Rr.forEach(n=>{const r=n.getAttribute("data-tower"),s=nn[r].levels[0].buildCost,o=P.gold>=s;n.classList.toggle("disabled",!o)});let t=null;if(Ut.hoveredCol>=0&&P.phase==="wave"){const n=Tt(Ut.hoveredCol,Ut.hoveredRow);let r=1;for(const s of P.enemies){if(!s.alive)continue;const o=s.worldX-n.x,a=s.worldZ-n.z,l=o*o+a*a;l<r&&(r=l,t=s)}}if(t){const n=os[t.type];wy.textContent=n.name,Ty.textContent=`${Math.ceil(t.hp)}/${n.hp}`,Ey.textContent=n.speed.toFixed(1),Ay.textContent=String(n.armor),xh.classList.remove("hidden")}else xh.classList.add("hidden")}let Cr=null;function sc(i){gs.textContent=i,To.classList.remove("hidden"),gs.style.animation="none",gs.offsetWidth,gs.style.animation="",Cr&&clearTimeout(Cr),Cr=window.setTimeout(()=>{To.classList.add("hidden")},2e3)}let Pr=null;function Gy(i){const e=i>=10;_s.textContent=e?`⚡ x${i} MEGA COMBO!`:`🔥 x${i} Kill Streak!`,_s.className=e?"streak-mega":"streak-normal",_s.classList.remove("hidden"),Pr&&clearTimeout(Pr),Pr=window.setTimeout(()=>{_s.classList.add("hidden")},1800)}let Bi=null;function Vy(){Bi&&clearTimeout(Bi),Er.classList.remove("hidden"),Er.style.animation="none",Er.offsetWidth,Er.style.animation="",Bi=window.setTimeout(()=>{Er.classList.add("hidden"),Bi=null},2400)}let Lr=null;function Wy(i){Eo.textContent=`🏆 Milestone Wave ${i}! +500g!`,ec.classList.remove("hidden"),Eo.style.animation="none",Eo.offsetWidth,Eo.style.animation="",Lr&&clearTimeout(Lr),Lr=window.setTimeout(()=>{ec.classList.add("hidden")},3500)}const Xy=document.getElementById("achievement-toasts");function qy(i){const e=document.createElement("div");e.className="ach-toast",e.innerHTML=`<div class="ach-emoji">${i.emoji}</div><div class="ach-body"><div class="ach-kicker">Achievement Unlocked</div><div class="ach-name">${i.name}</div><div class="ach-desc">${i.desc}</div></div>`,Xy.appendChild(e),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},4400)}function ys(i,e){const t={event:i,payload:e};for(const n of Xl)if(!at.achievements.includes(n.id))try{n.check(P,t)&&iy(at,n.id)&&qy(n)}catch{}}Xe.on("enemyKilled",i=>ys("enemyKilled",{enemyId:i.enemyId,bounty:i.bounty})),Xe.on("streakBonus",i=>ys("streakBonus",{streak:i.streak})),Xe.on("waveCleared",i=>ys("waveCleared",{wave:i.wave,perfect:i.perfect})),Xe.on("milestone",i=>ys("milestone",{wave:i.wave})),Xe.on("gameOver",i=>ys("gameOver",{won:i.won,score:i.score}));const wh=document.getElementById("hs-score"),Th=document.getElementById("hs-sub");function Ro(){const i=at.highScores[wn];i?(wh.textContent=String(i.score),Th.textContent=`Wave ${i.wave} · ${i.rank} · ${wn}`):(wh.textContent="—",Th.textContent=`No record on ${wn}`),Ky()}const Yy=document.getElementById("lt-runs"),jy=document.getElementById("lt-kills"),$y=document.getElementById("lt-best-wave");function Ky(){Yy.textContent=String(at.lifetime.runs),jy.textContent=String(at.lifetime.totalKills),$y.textContent=String(at.lifetime.highestWaveReached)}const Zy=[{id:"damage",emoji:"🗡",name:"Overcharge",desc:"+20% tower damage (stacks)",apply:()=>{P.buffDamageMult*=1.2}},{id:"range",emoji:"🎯",name:"Long Sight",desc:"+15% tower range (stacks)",apply:()=>{P.buffRangeMult*=1.15}},{id:"gold",emoji:"💰",name:"Gold Rush",desc:"+25% gold from kills (stacks)",apply:()=>{P.buffGoldMult*=1.25}},{id:"fortify",emoji:"❤",name:"Fortify",desc:"+5 lives and +5 max lives",apply:()=>{P.maxLives+=5,P.lives=Math.min(P.maxLives,P.lives+5)}},{id:"bounty",emoji:"🏦",name:"War Chest",desc:"Instant +300 gold",apply:()=>{P.gold+=300}}],oc=document.getElementById("buff-modal"),Eh=document.getElementById("buff-cards"),Jy=document.getElementById("buff-wave");function Qy(){const i=Zy.slice(),e=[];for(;e.length<3&&i.length;){const t=Math.floor(Math.random()*i.length);e.push(i.splice(t,1)[0])}return e}function eS(i){if(P.buffChoicePending)return;P.buffChoicePending=!0,P.paused=!0,Jy.textContent=String(i);const e=Qy();Eh.innerHTML="";for(const t of e){const n=document.createElement("button");n.className="buff-card",n.innerHTML=`<span class="card-emoji">${t.emoji}</span><span class="card-name">${t.name}</span><span class="card-desc">${t.desc}</span>`,n.addEventListener("click",()=>{t.apply(),P.floatingTexts.push({id:P.nextId++,worldX:0,worldZ:0,value:`${t.emoji} ${t.name}`,color:"#ffd486",life:2.5,maxLife:2.5}),tS()}),Eh.appendChild(n)}oc.classList.remove("hidden")}function tS(){oc.classList.add("hidden"),P.buffChoicePending=!1,P.paused=!1}function nS(i,e){const t=new A(i,.6,e);return t.project(on),{x:(t.x*.5+.5)*window.innerWidth,y:(-t.y*.5+.5)*window.innerHeight}}const Ss=new Map;function iS(i){for(let e=P.floatingTexts.length-1;e>=0;e--){const t=P.floatingTexts[e];if(t.life-=i,t.life<=0){const s=Ss.get(t.id);s&&(_h.removeChild(s),Ss.delete(t.id)),P.floatingTexts.splice(e,1);continue}if(!Ss.has(t.id)){const s=document.createElement("div");s.className="floating-text",s.textContent=t.value,s.style.color=t.color,s.style.animationDuration=`${t.maxLife}s`,_h.appendChild(s),Ss.set(t.id,s)}const n=Ss.get(t.id),r=nS(t.worldX,t.worldZ);n.style.left=`${r.x}px`,n.style.top=`${r.y}px`}}function Ah(i){Et=i;const e=nn[i.type],t=e.levels[i.level];document.getElementById("panel-tower-name").textContent=e.name,document.getElementById("panel-tower-level").textContent=`Lv.${i.level+1}`,document.getElementById("panel-dmg").textContent=String(t.damage),document.getElementById("panel-spd").textContent=`${t.cooldownSec}s`,document.getElementById("panel-rng").textContent=String(t.range);const n=document.getElementById("panel-special"),r=[];t.aoeRadius>0&&r.push(`AOE ${t.aoeRadius}`),t.slow&&r.push(`Slow ${Math.round(t.slow.pct*100)}%`),t.dot&&r.push(`DOT ${t.dot.dps}/s ${t.dot.durationSec}s`),t.chain&&r.push(`Chain ×${t.chain.targets}`),r.push(`🗡 ${i.kills}`),n.textContent=r.join(" | "),document.querySelectorAll(".target-btn").forEach(c=>{const u=c.getAttribute("data-mode");c.classList.toggle("active",i.targetingMode===u),c.onclick=()=>{i.targetingMode=u,document.querySelectorAll(".target-btn").forEach(d=>d.classList.toggle("active",d.getAttribute("data-mode")===u))}});const s=document.getElementById("upgrade-btn"),o=document.getElementById("evolve-container"),a=document.getElementById("sell-btn"),l=e.levels;if(o.classList.add("hidden"),o.innerHTML="",s.style.display="block",i.level>=l.length-1)if(e.evolutions&&e.evolutions.length>0){s.style.display="none",o.classList.remove("hidden");for(const c of e.evolutions){const u=document.createElement("button");u.className="action-btn evolve",u.innerHTML=`⭐ ${c.name} (<span class="evolve-cost">${c.cost}</span>g)<div style="font-size: 0.8em; margin-top: 2px;">${c.desc}</div>`,u.disabled=P.gold<c.cost,u.onclick=()=>{Et&&Nd(P,Et.id,c.type)},o.appendChild(u)}}else s.disabled=!0,s.textContent="⬆ MAX";else{const c=l[i.level+1].upgradeCost;s.disabled=!Fx(P,i),s.innerHTML=`⬆ Upgrade (<span id="upgrade-cost">${c}</span>g)`}document.getElementById("sell-value").textContent=String(Ud(i)),a.innerHTML=`💰 Sell (<span id="sell-value">${Ud(i)}</span>g)`,Mh.classList.remove("hidden"),an.showRange(i,t.range)}function Ir(){Et=null,Mh.classList.add("hidden"),an.hideRange()}const rS=document.getElementById("end-best-badge");function Rh(){const i=P.phase==="won";yh.textContent=i?"🎉 Victory!":"💀 Defeat",yh.style.color=i?"#ffd700":"#ff5555",ky.textContent=`Score: ${P.score}`;let e="C";for(const r of yx.ranks)if(P.score>=r.min){e=r.name;break}Sh.textContent=e,Sh.className=`rank rank-${e}`;const t=P.endlessMode?P.currentWave+1:Math.min(P.currentWave+1,Gt.waves.length),n=ny(at,P.difficulty,P.score,t,e);rS.classList.toggle("hidden",!n),ry(at,i,P.totalKills,P.currentWave,P.stats.towersBuilt,t),Ro(),document.getElementById("stat-kills").textContent=P.totalKills.toString(),document.getElementById("stat-streak").textContent=P.stats.longestStreak.toString(),document.getElementById("stat-perfect").textContent=P.perfectWaves.toString(),document.getElementById("stat-built").textContent=P.stats.towersBuilt.toString(),document.getElementById("stat-gold").textContent=P.stats.goldEarned.toString(),document.getElementById("stat-dmg").textContent=Math.round(P.stats.totalDamageDealt).toString(),ic.classList.remove("hidden")}Rr.forEach(i=>{i.addEventListener("click",e=>{e.stopPropagation();const t=i.getAttribute("data-tower");P.gold<nn[t].levels[0].buildCost||(bn===t?(bn=null,i.classList.remove("selected"),xs.style.display="none",Ut.hideGhost()):(Rr.forEach(n=>n.classList.remove("selected")),bn=t,i.classList.add("selected"),xs.style.display="",Ir()))}),i.addEventListener("mouseenter",()=>{const e=i.getAttribute("data-tower");if(!e||!nn[e])return;const t=nn[e],n=t.levels[0];Oy.textContent=t.name+" Tower",By.textContent="Type: "+t.damageType,zy.innerHTML=`
        ...
        `;let r="";n.slow?r=`Slows by ${Math.round(n.slow.pct*100)}% for ${n.slow.durationSec}s`:n.dot?r=`DOT: ${n.dot.dps} dmg/s (${n.dot.durationSec}s)`:n.chain?r=`Chains to ${n.chain.targets} targets`:n.aoeRadius>0&&(r=`AOE Radius: ${n.aoeRadius}`),Hy.textContent=r;const s=i.getBoundingClientRect();Qn.style.left=`${s.left+s.width/2}px`,Qn.style.transform="translate(-50%, calc(-100% - 10px))",Qn.style.top=`${s.top}px`,Qn.classList.remove("hidden")}),i.addEventListener("mouseleave",()=>{Qn.classList.add("hidden")})}),xs.addEventListener("click",i=>{i.stopPropagation(),bn=null,Rr.forEach(e=>e.classList.remove("selected")),xs.style.display="none",Ut.hideGhost()}),Ql.addEventListener("click",()=>{P.speedMultiplier=P.speedMultiplier===1?2:P.speedMultiplier===2?4:1,Ql.textContent=P.speedMultiplier+"×",at.prefs.speedMultiplier=P.speedMultiplier,xi(at)}),ms.addEventListener("click",()=>{Dt.init();const i=Dt.toggle();ms.textContent=i?"🔊":"🔇",ms.style.opacity=i?"1":"0.5",at.prefs.soundEnabled=i,xi(at)}),Jl.addEventListener("click",Ch);function Ch(){P.paused=!P.paused,Jl.textContent=P.paused?"▶":"⏸",Jl.classList.toggle("active",P.paused)}window.addEventListener("keydown",i=>{if(P.phase==="idle"||P.phase==="won"||P.phase==="lost")return;const e=i.key.toLowerCase();if(e==="p"){(P.phase==="wave"||P.phase==="prep")&&Ch();return}if(Ar.classList.contains("hidden")){if(e>="1"&&e<="7"){const t=Number(e)-1;t>=0&&t<Rr.length&&Rr[t].click()}e==="u"&&Et&&document.getElementById("upgrade-btn").click(),e==="s"&&Et&&document.getElementById("sell-btn").click(),e==="q"&&Co(0),e==="w"&&Co(1),e==="e"&&Co(2),i.key==="Escape"&&(bn?xs.click():Et&&document.getElementById("panel-close-btn").click())}});const Ph=document.querySelectorAll(".skill-btn");Ph.forEach(i=>{i.addEventListener("click",()=>{const e=parseInt(i.getAttribute("data-skill")||"0",10);Co(e)})});function Co(i){if(P.phase!=="wave"&&P.phase!=="prep")return;const e=P.skills[i];if(!(!e||e.remaining>0)){if(i===0)for(const t of P.enemies)t.alive&&(t.hp-=200,t.hp<=0?Cl(P,t):P.floatingTexts.push({id:P.nextId++,worldX:t.worldX,worldZ:t.worldZ,value:"-200",color:"#ff4444",life:1,maxLife:1}));else if(i===1)for(const t of P.enemies)t.alive&&(t.slow={pct:1,remaining:5});else i===2&&(P.lives=Math.min(P.maxLives,P.lives+5),ei());e.remaining=e.cooldown,ac()}}function ac(){Ph.forEach(i=>{const e=parseInt(i.getAttribute("data-skill")||"0",10),t=P.skills[e],n=i.querySelector(".skill-cd");t&&t.remaining>0?(i.classList.add("on-cooldown"),n.classList.remove("hidden"),n.textContent=Math.ceil(t.remaining)+"s"):(i.classList.remove("on-cooldown"),n.classList.add("hidden"))})}Zl.addEventListener("click",()=>{P.phase==="prep"&&(P.gold+=50,P.floatingTexts.push({id:P.nextId++,worldX:0,worldZ:0,value:"⏩ +50g Skip",color:"#aaff55",life:1.6,maxLife:1.6}),P.prepTimer=0,Zl.classList.add("hidden"),ei())}),document.getElementById("upgrade-btn").addEventListener("click",()=>{Et&&Dd(P,Et.id)}),document.getElementById("sell-btn").addEventListener("click",()=>{Et&&Nx(P,Et.id)}),document.getElementById("panel-close-btn").addEventListener("click",()=>{Ir()}),document.getElementById("start-btn").addEventListener("click",async()=>{await vy,Fy.classList.add("hidden"),Oh(),P.endlessMode=at.prefs.endlessMode,Dt.init(),Dt.startMusic(),Rl(P),sc("Wave 1")});const lc=document.querySelectorAll(".diff-btn"),Lh=document.getElementById("diff-desc"),Ih={easy:"Easy difficulty — 600g, 30 lives, 25% weaker enemies",normal:"Standard difficulty — 400g, 20 lives",hard:"Hard difficulty — 250g, 10 lives, 40% tougher enemies & slightly faster"};lc.forEach(i=>{i.addEventListener("click",()=>{lc.forEach(e=>e.classList.remove("active")),i.classList.add("active"),wn=i.getAttribute("data-diff"),Lh.textContent=Ih[wn],at.prefs.difficulty=wn,xi(at),P=El(wn),P.speedMultiplier=at.prefs.speedMultiplier,ei(),Ro()})});const cc=document.getElementById("endless-toggle");cc.addEventListener("change",()=>{at.prefs.endlessMode=cc.checked,xi(at)}),(function(){lc.forEach(e=>{e.classList.toggle("active",e.getAttribute("data-diff")===wn)}),Lh.textContent=Ih[wn],Ql.textContent=P.speedMultiplier+"×",at.prefs.soundEnabled||(Dt.toggle(),ms.textContent="🔇",ms.style.opacity="0.5"),cc.checked=at.prefs.endlessMode,Ro()})();const Po=document.getElementById("achievements-modal"),Dh=document.getElementById("ach-grid"),sS=document.getElementById("ach-count");function Uh(){Dh.innerHTML="";let i=0;for(const e of Xl){const t=at.achievements.includes(e.id);t&&i++;const n=document.createElement("div");n.className=`ach-row ${t?"unlocked":"locked"}`,n.innerHTML=`<div class="row-emoji">${t?e.emoji:"🔒"}</div><div class="row-body"><div class="row-name">${e.name}</div><div class="row-desc">${e.desc}</div></div>`,Dh.appendChild(n)}sS.textContent=`${i}/${Xl.length}`}document.getElementById("achievements-btn").addEventListener("click",()=>{Uh(),Po.classList.remove("hidden")}),document.getElementById("ach-close-btn").addEventListener("click",()=>{Po.classList.add("hidden")}),Po.addEventListener("click",i=>{i.target.classList.contains("ach-backdrop")&&Po.classList.add("hidden")});const Mi=document.getElementById("ach-reset-btn");let Lo=!1,Dr=null;Mi.addEventListener("click",()=>{if(!Lo){Lo=!0,Mi.classList.add("confirming"),Mi.textContent="⚠ Click again to confirm reset",Dr&&clearTimeout(Dr),Dr=window.setTimeout(()=>{Lo=!1,Mi.classList.remove("confirming"),Mi.textContent="⟲ Reset Progress"},4e3);return}sy(at),Lo=!1,Dr&&(clearTimeout(Dr),Dr=null),Mi.classList.remove("confirming"),Mi.textContent="✓ Reset",setTimeout(()=>{Mi.textContent="⟲ Reset Progress"},1400),Uh(),Ro()}),ki(document.getElementById("hud"),"hud"),ki(document.getElementById("skill-bar"),"skillBar"),ki(document.getElementById("build-menu"),"buildMenu"),ki(document.getElementById("next-wave-preview"),"nextWavePreview"),ki(document.getElementById("tower-panel"),"towerPanel"),ki(document.getElementById("enemy-panel"),"enemyPanel"),ki(document.getElementById("wave-modifier"),"waveModifier"),document.getElementById("reset-layout-btn").addEventListener("click",()=>{dy(),P.floatingTexts.push({id:P.nextId++,worldX:0,worldZ:0,value:"🔁 介面位置已重設",color:"#9be8ff",life:1.6,maxLife:1.6})}),Uy.addEventListener("click",()=>{Ar.classList.remove("hidden")}),Ny.addEventListener("click",()=>{Ar.classList.add("hidden")}),Ar.addEventListener("click",i=>{i.target===Ar&&Ar.classList.add("hidden")}),document.getElementById("restart-btn").addEventListener("click",()=>{ic.classList.add("hidden"),P=El(wn),P.speedMultiplier=at.prefs.speedMultiplier,P.endlessMode=at.prefs.endlessMode,Oh(),an.sync(P),ei(),ac(),Ir(),Rl(P),sc("Wave 1")}),document.getElementById("home-btn").addEventListener("click",()=>{window.location.href="../../../index.html"}),_i.addEventListener("click",()=>{if(Zt.twoFingerActive||P.phase==="idle"||P.phase==="won"||P.phase==="lost")return;const i=Ut.hoveredCol,e=Ut.hoveredRow;if(i<0||e<0)return;const t=P.towers.find(n=>n.col===i&&n.row===e);t?Ah(t):bn?Id(P,bn,i,e):Ir()}),_i.addEventListener("mousemove",i=>{Ut.updateMouse(i,on),Nh()}),_i.addEventListener("touchmove",i=>{i.touches.length===1&&!Zt.twoFingerActive&&(Ut.updateMouse(i,on),Nh())},{passive:!0});function Nh(){if(!bn||Ut.hoveredCol<0){Ut.hideGhost();return}const i=Ld(P,Ut.hoveredCol,Ut.hoveredRow)&&P.gold>=nn[bn].levels[0].buildCost,e=nn[bn].levels[0].range;Ut.showGhost(Ut.hoveredCol,Ut.hoveredRow,i,bn,e)}_i.addEventListener("wheel",i=>{i.preventDefault(),Zt.zoom(i.deltaY)},{passive:!1}),_i.addEventListener("touchstart",Zt.onTouchStart,{passive:!0}),_i.addEventListener("touchmove",Zt.onTouchMove,{passive:!1}),_i.addEventListener("touchend",Zt.onTouchEnd,{passive:!0}),window.addEventListener("resize",()=>{Zt.resize(Dn),Oi&&Oi.resize(window.innerWidth,window.innerHeight)});let Fh=0,Ur=0,uc=-1,zi=null,kh=0;function Oh(){Ur=0,uc=-1,Yl=-1,Ao=-2,nc="__init__",zi=null,oc.classList.add("hidden"),Cr&&(clearTimeout(Cr),Cr=null),Pr&&(clearTimeout(Pr),Pr=null),Lr&&(clearTimeout(Lr),Lr=null),Bi&&(clearTimeout(Bi),Bi=null),To.classList.add("hidden"),_s.classList.add("hidden"),ec.classList.add("hidden"),Er.classList.add("hidden")}function Io(){Oi?Oi.render():Dn.render(Wt.scene,on)}function Bh(i){var o,a;requestAnimationFrame(Bh);const e=Math.min((i-Fh)/1e3,.1);Fh=i;const t=i*.001;if(P.phase==="idle"){wo.update(t),yi.update(e,P.lives,P.maxLives,on),Io();return}if(P.phase==="won"||P.phase==="lost"){ic.classList.contains("hidden")&&Rh(),zi!=="off"&&(Dt.setMusicPhase("off"),zi="off"),wo.update(t),yi.update(e,P.lives,P.maxLives,on),Io();return}if(P.paused){wo.update(t),yi.update(e,P.lives,P.maxLives,on),Io();return}const n=e*P.speedMultiplier;Ur+=n;const r=5;Ur>In*r&&(Ur=In*r);const s=new Map;for(const l of P.projectiles)s.set(l.id,{id:l.id,targetX:l.targetX,targetZ:l.targetZ,towerType:l.towerType});for(;Ur>=In;){wd(P,In),Ed(P,In),Rd(P,In),Cd(P,In),Ur-=In;const l=P.phase;if(l==="won"||l==="lost"){Rh();break}}if(P.phase==="wave"||P.phase==="prep"){for(const l of P.skills)l.remaining>0&&(l.remaining=Math.max(0,l.remaining-e));ac()}if(P.phase==="prep"&&zi!=="prep"?(Dt.setMusicPhase("prep"),zi="prep"):P.phase==="wave"&&zi!=="wave"&&(Dt.setMusicPhase("wave"),zi="wave"),P.currentWave!==uc&&P.phase==="wave"&&(uc=P.currentWave,sc(`Wave ${P.currentWave+1}`)),P.phase==="prep"){const l=Math.ceil(P.prepTimer),c=Gt.waves[Al(P)],u=((o=c==null?void 0:c.groups)==null?void 0:o.reduce((h,f)=>h+f.count,0))??"?",d=((a=c==null?void 0:c.groups)==null?void 0:a.map(h=>`${bh[h.type]??"?"}×${h.count}`).join(" "))??"";gs.textContent=`Wave ${P.currentWave+1} — ${u} enemies | ${d} | Next in ${l}s`,To.classList.remove("hidden")}for(const[l,c]of s.entries())P.projectiles.find(u=>u.id===l)||Jn.addExplosion(c.targetX,c.targetZ,c.towerType);an.animate(e,P),xy.sync(P,0,on),Jn.setCamera(on),Jn.sync(P,n),_y.sync(P,n),iS(e),wo.update(t),yi.update(e,P.lives,P.maxLives,on),Zt.tickShake(e),yy(P.currentWave),ze.isMobile?++kh>=4&&(kh=0,ei()):ei(),Et&&(P.towers.find(c=>c.id===Et.id)||Ir()),Io()}window.__TD={get state(){return P},LOGIC_DT:In,量模型:b_,門狀態(){return yi.狀態()},設曲率(i,e){bx(i,e)},設金倍(i){Sx(i)},塔尺(i){return an.measure(i)},塔同步(){an.sync(P),an.animate(.6,P)},地圖:{spawn:Tt(te.spawnCell[0],te.spawnCell[1]),goal:Tt(te.goalCell[0],te.goalCell[1])},開門(){yi.開門()},scene:Wt.scene,camera:on,renderer:Dn,tick(i=1,e=In){for(let t=0;t<i;t+=1)wd(P,e),Ed(P,e),Rd(P,e),Cd(P,e)},擂台(i=99999){return P.phase="wave",P.paused=!1,P.enemies=[],P.projectiles=[],P.towers=[],P.spawnCounts=P.spawnCounts.map(()=>0),P.waveEnemiesSpawned=P.waveEnemiesTotal,P.gold=i,P.lives=999,{phase:P.phase,gold:P.gold}},build(i,e,t){return Id(P,i,e,t)},upgrade(i){return Dd(P,i)},進化(i,e){return Nd(P,i,e)},spawn(i,e=0){Td(P,i);const t=P.enemies[P.enemies.length-1];if(e>0){const[n,r]=te.path[Math.min(e,te.path.length-1)],s=Tt(n,r);t.pathIndex=e,t.pathProgress=0,t.worldX=s.x,t.worldZ=s.z,t.prevWorldX=s.x,t.prevWorldZ=s.z}return{id:t.id,hp:t.hp,maxHp:t.maxHp,armor:t.armor,shield:t.shield,x:t.worldX,z:t.worldZ}},敵(i){const e=P.enemies.find(t=>t.id===i);return e?{hp:e.hp,alive:e.alive,shield:e.shield,dots:e.dots.length,slow:e.slow}:null}},requestAnimationFrame(Bh)})();
