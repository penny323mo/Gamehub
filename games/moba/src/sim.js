...
} from './constants.js?v=graph-token-8';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=graph-token-8';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=graph-token-8';
