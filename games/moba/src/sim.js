...
} from './constants.js?v=hubtap-25';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=hubtap-25';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=hubtap-25';
