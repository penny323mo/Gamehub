...
} from './constants.js?v=assets-29';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=assets-29';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=assets-29';
