...
} from './constants.js?v=fair-order-9';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=fair-order-9';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=fair-order-9';
