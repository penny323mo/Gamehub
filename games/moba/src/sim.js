...
} from './constants.js?v=context-resume-14';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=context-resume-14';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=context-resume-14';
