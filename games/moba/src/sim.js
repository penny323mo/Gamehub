...
} from './constants.js?v=tipcol-20';
import { CHAMPIONS, abilityRank, scaled } from './champions.js?v=tipcol-20';
import { ITEMS, MAX_ITEMS, itemBonus } from './items.js?v=tipcol-20';
