...
import { MAP, TEAM } from './constants.js?v=econ-22';
import { CHAMPION_LOOK, MINION_LOOK, ARENA_LOOK, TEAM_COLOUR, CLIP, championFx } from './looks.js?v=econ-22';
import { Rig } from './rig.js?v=econ-22';
import { Fx } from './fx.js?v=econ-22';
