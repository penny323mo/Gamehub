...
import { MAP, TEAM } from './constants.js?v=pick-21';
import { CHAMPION_LOOK, MINION_LOOK, ARENA_LOOK, TEAM_COLOUR, CLIP, championFx } from './looks.js?v=pick-21';
import { Rig } from './rig.js?v=pick-21';
import { Fx } from './fx.js?v=pick-21';
