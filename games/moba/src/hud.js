...
import { abilityRank } from './champions.js?v=hubtap-25';
import { armTap } from './tap.js?v=hubtap-25';
import { settings } from './settings.js?v=hubtap-25';
import { ITEMS, MAX_ITEMS, nextPurchase } from './items.js?v=hubtap-25';
import { TEAM, teamName, GAME_MAX, MAP } from './constants.js?v=hubtap-25';
