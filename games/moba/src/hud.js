...
import { abilityRank } from './champions.js?v=assets-27';
import { armTap } from './tap.js?v=assets-27';
import { settings } from './settings.js?v=assets-27';
import { ITEMS, MAX_ITEMS, nextPurchase } from './items.js?v=assets-27';
import { TEAM, teamName, GAME_MAX, MAP } from './constants.js?v=assets-27';
