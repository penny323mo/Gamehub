...
import { Assets } from './assets.js?v=assets-27';
import { armTap } from './tap.js?v=assets-27';
import { Sim } from './sim.js?v=assets-27';
import { createBot, updateBots } from './ai.js?v=assets-27';
import { View } from './view.js?v=assets-27';
import { Hud } from './hud.js?v=assets-27';
import { createInput } from './input.js?v=assets-27';
import { CHAMPIONS, CHAMPION_IDS } from './champions.js?v=assets-27';
import { TEAM, TICK, teamName } from './constants.js?v=assets-27';
import { CHAMPION_LOOK } from './looks.js?v=assets-27';
import { Sfx } from './sfx.js?v=assets-27';
import { planFrame } from './pace.js?v=assets-27';
import { settings } from './settings.js?v=assets-27';
import { renderPortraits } from './portraits.js?v=assets-27';
