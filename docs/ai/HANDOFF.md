...
- MOBA persistent context-recovery card and `assets-31` cache-bust, Royale loading feedback, Tower start-screen
  contrast, Elden browser-gate isolation, and the Ashen Rail production smoke remain part of the pushed history.
